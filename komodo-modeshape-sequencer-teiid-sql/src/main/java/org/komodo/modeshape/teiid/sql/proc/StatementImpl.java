...
import org.komodo.spi.query.sql.proc.Statement;

/**
 *
 */
public abstract class StatementImpl extends ASTNode implements Statement<SQLanguageVisitorImpl> {
     ...
     */
    public StatementImpl(TeiidSeqParser p, int id) {
        super(p, id);
    }
