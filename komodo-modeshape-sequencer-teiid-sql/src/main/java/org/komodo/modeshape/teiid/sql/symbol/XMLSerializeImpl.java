 ...
 *
 */
public class XMLSerializeImpl extends ASTNode implements BaseExpression, XMLSerialize<SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public XMLSerializeImpl(TeiidSeqParser p, int id) {
        super(p, id);
    }
    ...
    public BaseExpression getExpression() {
        return getChildforIdentifierAndRefType(TeiidSqlLexicon.XMLSerialize.EXPRESSION_REF_NAME, BaseExpression.class);
    }
    ...
    public XMLSerializeImpl clone() {
        XMLSerializeImpl clone = new XMLSerializeImpl(this.getTeiidParser(), this.getId());
