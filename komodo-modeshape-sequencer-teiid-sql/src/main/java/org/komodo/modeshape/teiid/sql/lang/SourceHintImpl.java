...
import org.komodo.spi.query.sql.lang.SourceHint;

/**
 *
 */
public class SourceHintImpl extends ASTNode implements SourceHint {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public SourceHintImpl(TeiidSeqParser p, int id) {
        super(p, id);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        SourceHintImpl other = (SourceHintImpl)obj;
    ...
    @Override
    public SourceHintImpl clone() {
        SourceHintImpl clone = new SourceHintImpl(this.getTeiidParser(), this.getId());
