 ...
 *
 */
public class TextLineImpl extends ASTNode implements BaseExpression, TextLine<SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public TextLineImpl(TeiidSeqParser p, int id) {
        super(p, id);
    ...
    public List<DerivedColumnImpl> getExpressions() {
        return getChildrenforIdentifierAndRefType(
                                                  TeiidSqlLexicon.TextLine.EXPRESSIONS_REF_NAME, DerivedColumnImpl.class);
    }

    public void setExpressions(List<DerivedColumnImpl> expressions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TextLineImpl other = (TextLineImpl)obj;
    ...
    @Override
    public TextLineImpl clone() {
        TextLineImpl clone = new TextLineImpl(this.getTeiidParser(), this.getId());
