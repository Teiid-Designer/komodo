...
import org.komodo.spi.query.sql.lang.TextColumn;
import org.komodo.spi.runtime.version.DefaultTeiidVersion.Version;

/**
 *
 */
public class TextColumnImpl extends ProjectedColumnImpl implements TextColumn<SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public TextColumnImpl(TeiidSeqParser p, int id) {
        super(p, id);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TextColumnImpl other = (TextColumnImpl)obj;
    ...
    @Override
    public TextColumnImpl clone() {
        TextColumnImpl clone = new TextColumnImpl(this.getTeiidParser(), this.getId());
