 ...
 *
 */
public class LoopStatementImpl extends StatementImpl implements Labeled, BaseSubqueryContainer<CommandImpl>, LoopStatement<SQLanguageVisitorImpl, CommandImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public LoopStatementImpl(TeiidSeqParser p, int id) {
        super(p, id);
    ...
    private BlockImpl getBlock() {
        return getChildforIdentifierAndRefType(TeiidSqlLexicon.LoopStatement.BLOCK_REF_NAME, BlockImpl.class);
    }

    public void setBlock(BlockImpl asBlock) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        LoopStatementImpl other = (LoopStatementImpl)obj;
    ...
    @Override
    public LoopStatementImpl clone() {
        LoopStatementImpl clone = new LoopStatementImpl(this.getTeiidParser(), this.getId());
