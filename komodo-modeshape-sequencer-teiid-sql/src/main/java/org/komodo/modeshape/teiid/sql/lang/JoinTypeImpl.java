 ...
 *
 */
public class JoinTypeImpl extends ASTNode implements JoinType<SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public JoinTypeImpl(TeiidSeqParser p, int id) {
        super(p, id);
    }
    ...
    public JoinTypeImpl clone() {
        JoinTypeImpl clone = new JoinTypeImpl(this.getTeiidParser(), this.getId());
