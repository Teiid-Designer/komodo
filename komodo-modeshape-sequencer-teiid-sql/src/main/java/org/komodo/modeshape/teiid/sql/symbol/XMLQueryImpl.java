 ...
 *
 */
public class XMLQueryImpl extends ASTNode implements BaseExpression, XMLQuery<SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public XMLQueryImpl(TeiidSeqParser p, int id) {
        super(p, id);
    ...
    public XMLNamespacesImpl getNamespaces() {
        return getChildforIdentifierAndRefType(
                                               TeiidSqlLexicon.XMLQuery.NAMESPACES_REF_NAME, XMLNamespacesImpl.class);
    }
    ...
    public List<DerivedColumnImpl> getPassing() {
        return getChildrenforIdentifierAndRefType(
                                                  TeiidSqlLexicon.XMLQuery.PASSING_REF_NAME, DerivedColumnImpl.class);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        XMLQueryImpl other = (XMLQueryImpl)obj;
    ...
    @Override
    public XMLQueryImpl clone() {
        XMLQueryImpl clone = new XMLQueryImpl(this.getTeiidParser(), this.getId());
