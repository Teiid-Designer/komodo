 ...
 *
 */
public class XMLParseImpl extends ASTNode implements BaseExpression, XMLParse<SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public XMLParseImpl(TeiidSeqParser p, int id) {
        super(p, id);
    ...
    public BaseExpression getExpression() {
        return getChildforIdentifierAndRefType(TeiidSqlLexicon.XMLParse.EXPRESSION_REF_NAME, BaseExpression.class);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        XMLParseImpl other = (XMLParseImpl)obj;
    ...
    @Override
    public XMLParseImpl clone() {
        XMLParseImpl clone = new XMLParseImpl(this.getTeiidParser(), this.getId());
