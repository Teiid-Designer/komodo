 ...
 *
 */
public class ElementSymbolImpl extends SymbolImpl implements BaseExpression, ElementSymbol<GroupSymbolImpl, SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public ElementSymbolImpl(TeiidSeqParser p, int id) {
        super(p, id);
    }
    ...
    public GroupSymbolImpl getGroupSymbol() {
        return getChildforIdentifierAndRefType(
                                               TeiidSqlLexicon.ElementSymbol.GROUP_SYMBOL_REF_NAME, GroupSymbolImpl.class);
    }
    ...
    @Override
    public ElementSymbolImpl.DisplayMode getDisplayMode() {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ElementSymbolImpl other = (ElementSymbolImpl)obj;
    ...
    public ElementSymbolImpl clone() {
        ElementSymbolImpl clone = new ElementSymbolImpl(this.getTeiidParser(), this.getId());
