 ...
 *
 */
public class IntoImpl extends ASTNode implements Into<SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public IntoImpl(TeiidSeqParser p, int id) {
        super(p, id);
    }

    @Override
    public GroupSymbolImpl getGroup() {
        return getChildforIdentifierAndRefType(TeiidSqlLexicon.Into.GROUP_REF_NAME, GroupSymbolImpl.class);
    }
    ...
    public IntoImpl clone() {
        IntoImpl clone = new IntoImpl(this.getTeiidParser(), this.getId());
