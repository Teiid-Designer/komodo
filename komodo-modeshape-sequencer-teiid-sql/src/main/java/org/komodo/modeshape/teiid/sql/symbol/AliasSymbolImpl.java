 ...
 *
 */
public class AliasSymbolImpl extends SymbolImpl implements BaseExpression, AliasSymbol<BaseExpression, SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public AliasSymbolImpl(TeiidSeqParser p, int id) {
        super(p, id);
    }
    ...
    public BaseExpression getSymbol() {
        return getChildforIdentifierAndRefType(TeiidSqlLexicon.AliasSymbol.SYMBOL_REF_NAME, BaseExpression.class);
    }
    ...
    public AliasSymbolImpl clone() {
        AliasSymbolImpl clone = new AliasSymbolImpl(this.getTeiidParser(), this.getId());
