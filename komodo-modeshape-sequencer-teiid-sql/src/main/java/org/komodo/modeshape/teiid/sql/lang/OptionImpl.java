 ...
 *
 */
public class OptionImpl extends ASTNode implements Option<SQLanguageVisitorImpl>, TeiidSQLConstants.Reserved {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public OptionImpl(TeiidSeqParser p, int id) {
        super(p, id);
    }
    ...
    public OptionImpl clone() {
        OptionImpl clone = new OptionImpl(this.getTeiidParser(), this.getId());
