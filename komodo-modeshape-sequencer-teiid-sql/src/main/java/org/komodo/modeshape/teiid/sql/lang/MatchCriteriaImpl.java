 ...
 *
 */
public class MatchCriteriaImpl extends CriteriaImpl
    implements PredicateCriteria, MatchCriteria<BaseExpression, SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public MatchCriteriaImpl(TeiidSeqParser p, int id) {
        super(p, id);
    ...
    public BaseExpression getLeftExpression() {
        return getChildforIdentifierAndRefType(TeiidSqlLexicon.MatchCriteria.LEFT_EXPRESSION_REF_NAME, BaseExpression.class);
    }
    ...
    public BaseExpression getRightExpression() {
        return getChildforIdentifierAndRefType(TeiidSqlLexicon.MatchCriteria.RIGHT_EXPRESSION_REF_NAME, BaseExpression.class);
    }
    ...
    public boolean equals(Object obj) {
        ...
        MatchCriteriaImpl other = (MatchCriteriaImpl)obj;
    ...
    public MatchCriteriaImpl clone() {
        MatchCriteriaImpl clone = new MatchCriteriaImpl(this.getTeiidParser(), this.getId());
