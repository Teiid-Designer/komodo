 ...
 *
 */
public class CompareCriteriaImpl extends AbstractCompareCriteria implements CompareCriteria<BaseExpression, SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public CompareCriteriaImpl(TeiidSeqParser p, int id) {
        super(p, id);
    }

    @Override
    public BaseExpression getRightExpression() {
        return getChildforIdentifierAndRefType(TeiidSqlLexicon.CompareCriteria.RIGHT_EXPRESSION_REF_NAME, BaseExpression.class);
    }
    ...
    public CompareCriteriaImpl clone() {
        CompareCriteriaImpl clone = new CompareCriteriaImpl(this.getTeiidParser(), this.getId());
