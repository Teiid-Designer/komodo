 ...
 *
 */
public class TextTableImpl extends TableFunctionReferenceImpl implements TextTable<SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public TextTableImpl(TeiidSeqParser p, int id) {
        super(p, id);
        setUsingRowDelimiter(true);
    }

    public BaseExpression getFile() {
        return getChildforIdentifierAndRefType(TeiidSqlLexicon.TextTable.FILE_REF_NAME, BaseExpression.class);
    }

    public void setFile(BaseExpression file) {
        setChild(TeiidSqlLexicon.TextTable.FILE_REF_NAME, file);
    }

    @Override
    public List<TextColumnImpl> getColumns() {
        return getChildrenforIdentifierAndRefType(
                                                  TeiidSqlLexicon.TextTable.COLUMNS_REF_NAME, TextColumnImpl.class);
    }

    public void setColumns(List<TextColumnImpl> columns) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TextTableImpl other = (TextTableImpl)obj;
    ...
    @Override
    public TextTableImpl clone() {
        TextTableImpl clone = new TextTableImpl(this.getTeiidParser(), this.getId());
