...
public class TeiidCompletionParser extends AbstractTeiidSeqParser/*@bgen(jjtree)*/implements TeiidCompletionParserTreeConstants, TeiidCompletionParserConstants {/*@bgen(jjtree)*/
 ...
 */
  ...
  final public CommandImpl forEachRowTriggerAction(ParseInfo info) throws ParseException {
 ...
 * Top-Level function so includes try catch
 */
  final public CommandImpl procedureBodyCommand(ParseInfo info) throws ParseException {
    try {
      if (jj_2_8(2)) {
        jj_consume_token(CREATE);
