...
public final class RestVdbCondition extends KomodoRestEntity {
    ...
    public RestVdbCondition(URI baseUri, String id, String dataPath, KomodoType kType, boolean hasChildren,
        ...
        addLink(new RestLink(LinkType.SELF, getUriBuilder()
                             .buildVdbPermissionChildUri(LinkType.SELF, parentVdb, dataRole, permission, LinkType.CONDITIONS, id)));
        addLink(new RestLink(LinkType.PARENT, getUriBuilder()
                             .buildVdbPermissionChildUri(LinkType.PARENT, parentVdb, dataRole, permission, LinkType.CONDITIONS, id)));
    }
