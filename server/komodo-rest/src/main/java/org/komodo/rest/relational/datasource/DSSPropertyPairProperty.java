 ...
 */
public class DSSPropertyPairProperty extends DataSourceSchemaProperty {

    public static final String PROPERTY_NAME_LABEL = "name";

    public static final String PROPERTY_VALUE_LABEL = "value";

    private List<DataSourceSchemaProperty> properties = new ArrayList<DataSourceSchemaProperty>();

    public DSSPropertyPairProperty(String name) {
