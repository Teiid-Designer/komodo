...
/**
 * A GSON serializer/deserializer for {@link RestConnection}s.
 */
public final class ConnectionSerializer extends BasicEntitySerializer<RestConnection> {
    ...
    @Override
    protected RestConnection createEntity() {
