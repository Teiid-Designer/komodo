...
public class DataSourceSchemaProperty {
    ...
    public DataSourceSchemaProperty(String name, String type, boolean required, boolean repeatable, int limit) {
        setName(name);
        setType(type);
    ...
    public DataSourceSchemaProperty(String name) {
        setName(name);
    }
