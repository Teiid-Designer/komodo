...
/**
 * A {@link ShellCommand command} to set {@link Index} properties.
 */
public final class UnsetIndexPropertyCommand extends IndexShellCommand {
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( IndexCommandsI18n.unsetIndexPropertyHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( IndexCommandsI18n.unsetIndexPropertyExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( IndexCommandsI18n.unsetIndexPropertyUsage ) );
    }
