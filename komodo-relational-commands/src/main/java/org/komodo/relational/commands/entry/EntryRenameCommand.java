...
/**
 * Since {@link Entry entry} has no children, this command overrides the default {@link RenameCommand} to not allow children to be
 * renamed.
 */
public final class EntryRenameCommand extends RenameCommand {
     ...
     */
    public EntryRenameCommand( final WorkspaceStatus status ) {
        super( status );
    }
