...
public final class SetSchemaPropertyCommand extends SchemaShellCommand {
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( SchemaCommandsI18n.setSchemaPropertyHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( SchemaCommandsI18n.setSchemaPropertyExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( SchemaCommandsI18n.setSchemaPropertyUsage ) );
    }
