...
public final class DeleteColumnCommand extends ViewShellCommand {
    ...
    protected CommandResult doExecute() {
        ...
        try {
            ...
            result = new CommandResultImpl( I18n.bind( ViewCommandsI18n.columnDeleted, columnName ) );
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( ViewCommandsI18n.deleteColumnHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( ViewCommandsI18n.deleteColumnExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( ViewCommandsI18n.deleteColumnUsage ) );
    }
