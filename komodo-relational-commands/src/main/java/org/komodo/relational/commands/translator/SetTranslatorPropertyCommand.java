...
/**
 * A shell command to set Translator properties
 */
public final class SetTranslatorPropertyCommand extends TranslatorShellCommand {
     ...
     */
    public SetTranslatorPropertyCommand( final WorkspaceStatus status ) {
        super( NAME, status );
    }
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( TranslatorCommandsI18n.setTranslatorPropertyHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( TranslatorCommandsI18n.setTranslatorPropertyExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( TranslatorCommandsI18n.setTranslatorPropertyUsage ) );
    }
