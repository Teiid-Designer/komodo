...
public final class UnsetTranslatorPropertyCommand extends TranslatorShellCommand {
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( TranslatorCommandsI18n.unsetTranslatorPropertyHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( TranslatorCommandsI18n.unsetTranslatorPropertyExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( TranslatorCommandsI18n.unsetTranslatorPropertyUsage ) );
    }
