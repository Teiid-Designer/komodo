...
/**
 * A shell command provider for connection.
 */
public class ConnectionCommandProvider implements ShellCommandProvider {

    /**
     * Constructs a command provider for VDB shell commands.
     */
    public ConnectionCommandProvider() {
        // nothing to do
    }
    ...
    public Set< Class< ? extends ShellCommand > > provideCommands() {
        ...
        result.add( SetConnectionPropertyCommand.class );
        result.add( UnsetConnectionPropertyCommand.class );
    ...
    @Override
    public Connection resolve ( final Repository.UnitOfWork uow, final KomodoObject kObj ) throws KException {
        if(Connection.RESOLVER.resolvable(uow, kObj)) {
            return Connection.RESOLVER.resolve(uow, kObj);
        }
        return null;
    }
