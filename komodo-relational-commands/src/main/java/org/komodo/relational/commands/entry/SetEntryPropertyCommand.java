...
/**
 * A shell command to set VDB Entry properties
 */
public final class SetEntryPropertyCommand extends EntryShellCommand {
     ...
     */
    public SetEntryPropertyCommand( final WorkspaceStatus status ) {
        super( NAME, status );
    }
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( EntryCommandsI18n.setEntryPropertyHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( EntryCommandsI18n.setEntryPropertyExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( EntryCommandsI18n.setEntryPropertyUsage ) );
    }
