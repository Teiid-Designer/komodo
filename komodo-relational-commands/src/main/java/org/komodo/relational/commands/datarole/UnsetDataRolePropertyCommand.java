...
/**
 * A shell command to unset {@link DataRole data role} properties.
 */
public final class UnsetDataRolePropertyCommand extends DataRoleShellCommand {
     ...
     */
    public UnsetDataRolePropertyCommand( final WorkspaceStatus status ) {
        super( NAME, status );
    }
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( DataRoleCommandsI18n.unsetDataRolePropertyHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( DataRoleCommandsI18n.unsetDataRolePropertyExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( DataRoleCommandsI18n.unsetDataRolePropertyUsage ) );
    }
