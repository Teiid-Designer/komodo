...
/**
 * A shell command to set the result set for a StoredProcedure.
 */
public final class SetResultSetCommand extends StoredProcedureShellCommand {
    ...
    protected CommandResult doExecute() {
        ...
        try {
            final String rsType = requiredArgument( 0, I18n.bind( StoredProcedureCommandsI18n.missingResultSetType ) );

            final StoredProcedure func = getStoredProcedure();
            if(rsType.equals(DataTypeResultSet.class.getSimpleName())) {
                ...
                new CommandResultImpl( false, I18n.bind( StoredProcedureCommandsI18n.invalidResultSetType, rsType ), null );
            }

            result = new CommandResultImpl( I18n.bind( StoredProcedureCommandsI18n.resultSetTypeSet, rsType ) );
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( StoredProcedureCommandsI18n.setResultSetHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( StoredProcedureCommandsI18n.setResultSetExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( StoredProcedureCommandsI18n.setResultSetUsage ) );
    }
