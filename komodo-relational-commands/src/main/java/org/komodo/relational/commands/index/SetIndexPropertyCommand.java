...
/**
 * A shell command to set {@link Index index} properties.
 */
public final class SetIndexPropertyCommand extends IndexShellCommand {
     ...
     */
    public SetIndexPropertyCommand( final WorkspaceStatus status ) {
        super( NAME, status );
    }
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( IndexCommandsI18n.setIndexPropertyHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( IndexCommandsI18n.setIndexPropertyExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( IndexCommandsI18n.setIndexPropertyUsage ) );
    }
