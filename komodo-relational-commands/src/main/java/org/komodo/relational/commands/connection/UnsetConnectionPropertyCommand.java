...
/**
 * A shell command to unset {@link Connection connection} properties.
 */
public final class UnsetConnectionPropertyCommand extends ConnectionShellCommand {
     ...
     */
    public UnsetConnectionPropertyCommand( final WorkspaceStatus status ) {
        super( NAME, status );
    }
    ...
    protected CommandResult doExecute() {
        ...
        try {
            ...
            if ( DESCRIPTION.equals( name ) ) {
                ...
                connection.setJdbc( transaction, Connection.DEFAULT_JDBC );
            } else {
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( ConnectionCommandsI18n.unsetConnectionPropertyHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( ConnectionCommandsI18n.unsetConnectionPropertyExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( ConnectionCommandsI18n.unsetConnectionPropertyUsage ) );
    }
