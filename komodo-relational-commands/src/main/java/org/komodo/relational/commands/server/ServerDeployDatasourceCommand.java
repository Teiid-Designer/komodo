...
public final class ServerDeployDatasourceCommand extends ServerShellCommand {
    ...
    protected CommandResult doExecute() {
        ...
        try {
            ...
            if(!getWorkspaceManager().hasChild(getTransaction(), sourceName, DataVirtLexicon.Connection.NODE_TYPE)) {
            ...
            final KomodoObject datasourceObj = getWorkspaceManager().getChild( getTransaction(),
                                                                               sourceName,
