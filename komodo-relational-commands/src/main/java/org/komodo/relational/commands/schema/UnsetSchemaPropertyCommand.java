...
/**
 * A shell command to unset {@link Schema schema} properties.
 */
public final class UnsetSchemaPropertyCommand extends SchemaShellCommand {
     ...
     */
    public UnsetSchemaPropertyCommand( final WorkspaceStatus status ) {
        super( NAME, status );
    }
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( SchemaCommandsI18n.unsetSchemaPropertyHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( SchemaCommandsI18n.unsetSchemaPropertyExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( SchemaCommandsI18n.unsetSchemaPropertyUsage ) );
    }
