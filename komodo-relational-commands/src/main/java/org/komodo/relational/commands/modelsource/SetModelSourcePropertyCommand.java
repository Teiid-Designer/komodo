...
public final class SetModelSourcePropertyCommand extends ModelSourceShellCommand {
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( ModelSourceCommandsI18n.setModelSourcePropertyHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( ModelSourceCommandsI18n.setModelSourcePropertyExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( ModelSourceCommandsI18n.setModelSourcePropertyUsage ) );
    }
