...
public final class DeleteParameterCommand extends VirtualProcedureShellCommand {
    ...
    protected CommandResult doExecute() {
        ...
        try {
            ...
            result = new CommandResultImpl( I18n.bind( VirtualProcedureCommandsI18n.parameterDeleted, paramName ) );
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( VirtualProcedureCommandsI18n.deleteParameterHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( VirtualProcedureCommandsI18n.deleteParameterExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( VirtualProcedureCommandsI18n.deleteParameterUsage ) );
    }
