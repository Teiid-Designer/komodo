...
/**
 * A shell command to unset {@link Parameter parameter} properties.
 */
public final class UnsetParameterPropertyCommand extends ParameterShellCommand {
     ...
     */
    public UnsetParameterPropertyCommand( final WorkspaceStatus status ) {
        super( NAME, status );
    }
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( ParameterCommandsI18n.unsetParameterPropertyHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( ParameterCommandsI18n.unsetParameterPropertyExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( ParameterCommandsI18n.unsetParameterPropertyUsage ) );
    }
