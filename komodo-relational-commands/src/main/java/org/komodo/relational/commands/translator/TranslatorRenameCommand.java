...
/**
 * Since {@link Translator translator} has no children, this command overrides the default {@link RenameCommand} to not allow
 * children to be renamed.
 */
public final class TranslatorRenameCommand extends RenameCommand {

    /**
     * @param status
     *        the shell's workspace status (cannot be <code>null</code>)
     */
    public TranslatorRenameCommand( final WorkspaceStatus status ) {
        super( status );
    }
