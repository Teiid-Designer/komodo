...
public final class SetConditionPropertyCommand extends ConditionShellCommand {
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( ConditionCommandsI18n.setConditionPropertyHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( ConditionCommandsI18n.setConditionPropertyExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( ConditionCommandsI18n.setConditionPropertyUsage ) );
    }
