...
/**
 * Test Class to test SetRecordCommand
 *
 */
...
public class SetRecordCommandTest extends AbstractCommandTest {
    ...
    /**
	 * Test for SetRecordCommand
	 */
	public SetRecordCommandTest( ) {
		super();
	}
    ...
    public void shouldSetRecordOn() throws Exception {
        ...
        writer.write("set-record on" + NEW_LINE);  //$NON-NLS-1$
        writer.close();
        
    	setup(cmdFile.getAbsolutePath(), SetRecordCommand.class);
    ...
    public void shouldSetRecordOff() throws Exception {
        ...
        writer.write("workspace" + NEW_LINE);  //$NON-NLS-1$
        writer.write("set-record on" + NEW_LINE);  //$NON-NLS-1$
        writer.write("set-record off" + NEW_LINE);  //$NON-NLS-1$
        writer.close();
