...
/**
 * Test Class to test SetGlobalPropertyCommand
 *
 */
...
public class SetGlobalPropertyCommandTest extends AbstractCommandTest {
    ...
    /**
	 * Test for SetGlobalPropertyCommand
	 */
	public SetGlobalPropertyCommandTest( ) {
		super();
	}
    ...
    public void test1() throws Exception {
    	...
    	setup(cmdFile.getAbsolutePath(), SetGlobalPropertyCommand.class);
