...
public class RealMetadataFactory {
    ...
    public TransformationMetadata exampleBQTCached() {
        if (CACHED_BQT == null)
            CACHED_BQT = exampleBQT();
 
        return CACHED_BQT;
    }
    
    public TransformationMetadata example1Cached() {
        if (CACHED_EXAMPLE1 == null)
            CACHED_EXAMPLE1 = example1();
 
        return CACHED_EXAMPLE1;
    }

    public TransformationMetadata aggregatesCached() {
        if (CACHED_AGGREGATES == null)
            CACHED_AGGREGATES = exampleAggregates();
 
        return CACHED_AGGREGATES;
    }

    public MetadataStore exampleBQTStore() {
        ...
        TCQueryNode vqtn2 = new TCQueryNode("SELECT Concat(stringKey, stringNum) as a12345 FROM BQT1.SmallA"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vqtg2 = createUpdatableVirtualGroup("SmallB", vqt, vqtn2); //$NON-NLS-1$        

        // Case 2589
        TCQueryNode vqtn2589 = new TCQueryNode("SELECT * FROM BQT1.SmallA WHERE StringNum = '10'"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vqtg2589 = createVirtualGroup("SmallA_2589", vqt, vqtn2589); //$NON-NLS-1$

        TCQueryNode vqtn2589a = new TCQueryNode("SELECT BQT1.SmallA.* FROM BQT1.SmallA INNER JOIN BQT1.SmallB ON SmallA.IntKey = SmallB.IntKey WHERE SmallA.StringNum = '10'"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vqtg2589a = createVirtualGroup("SmallA_2589a", vqt, vqtn2589a); //$NON-NLS-1$

        TCQueryNode vqtn2589b = new TCQueryNode("SELECT BQT1.SmallA.* FROM BQT1.SmallA INNER JOIN BQT1.SmallB ON SmallA.StringKey = SmallB.StringKey WHERE SmallA.StringNum = '10'"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vqtg2589b = createVirtualGroup("SmallA_2589b", vqt, vqtn2589b); //$NON-NLS-1$

        TCQueryNode vqtn2589c = new TCQueryNode("SELECT BQT1.SmallA.* FROM BQT1.SmallA INNER JOIN BQT1.SmallB ON SmallA.StringKey = SmallB.StringKey WHERE concat(SmallA.StringNum, SmallB.StringNum) = '1010'"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vqtg2589c = createVirtualGroup("SmallA_2589c", vqt, vqtn2589c); //$NON-NLS-1$
        
        TCQueryNode vqtn2589d = new TCQueryNode("SELECT BQT1.SmallA.* FROM BQT1.SmallA INNER JOIN BQT1.SmallB ON SmallA.StringKey = SmallB.StringKey WHERE SmallA.StringNum = '10' AND SmallA.IntNum = 10"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vqtg2589d = createVirtualGroup("SmallA_2589d", vqt, vqtn2589d); //$NON-NLS-1$

        TCQueryNode vqtn2589f = new TCQueryNode("SELECT * FROM VQT.SmallA_2589"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vqtg2589f = createVirtualGroup("SmallA_2589f", vqt, vqtn2589f); //$NON-NLS-1$

        TCQueryNode vqtn2589g = new TCQueryNode("SELECT * FROM SmallA_2589b"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vqtg2589g = createVirtualGroup("SmallA_2589g", vqt, vqtn2589g); //$NON-NLS-1$

        TCQueryNode vqtn2589h = new TCQueryNode("SELECT VQT.SmallA_2589.* FROM VQT.SmallA_2589 INNER JOIN BQT1.SmallB ON VQT.SmallA_2589.StringKey = SmallB.StringKey"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vqtg2589h = createVirtualGroup("SmallA_2589h", vqt, vqtn2589h); //$NON-NLS-1$
        
        TCQueryNode vqtn2589i = new TCQueryNode("SELECT BQT1.SmallA.* FROM BQT1.SmallA INNER JOIN BQT1.SmallB ON SmallA.StringKey = SmallB.StringKey WHERE SmallA.StringNum = '10' AND SmallB.StringNum = '10'"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vqtg2589i = createVirtualGroup("SmallA_2589i", vqt, vqtn2589i); //$NON-NLS-1$

        // defect 15355
        TCQueryNode vqtn15355  = new TCQueryNode("SELECT convert(IntKey, string) as StringKey, BigIntegerValue FROM BQT1.SmallA UNION SELECT StringKey, (SELECT BigIntegerValue FROM BQT3.SmallA WHERE BQT3.SmallA.BigIntegerValue = BQT2.SmallA.StringNum) FROM BQT2.SmallA"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vqtg15355  = createVirtualGroup("Defect15355", vqt, vqtn15355); //$NON-NLS-1$
        TCQueryNode vqtn15355a  = new TCQueryNode("SELECT StringKey, StringNum, BigIntegerValue FROM BQT1.SmallA UNION SELECT StringKey, StringNum, (SELECT BigIntegerValue FROM BQT3.SmallA WHERE BQT3.SmallA.BigIntegerValue = BQT2.SmallA.StringNum) FROM BQT2.SmallA"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vqtg15355a  = createVirtualGroup("Defect15355a", vqt, vqtn15355a); //$NON-NLS-1$
        TCQueryNode vqtn15355b  = new TCQueryNode("SELECT convert(IntKey, string) as IntKey, BigIntegerValue FROM BQT1.SmallA UNION SELECT StringKey, (SELECT BigIntegerValue FROM BQT3.SmallA WHERE BQT3.SmallA.BigIntegerValue = BQT2.SmallA.StringNum) FROM BQT2.SmallA"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vqtg15355b  = createVirtualGroup("Defect15355b", vqt, vqtn15355b); //$NON-NLS-1$
        
        TCQueryNode bvqtn1 = new TCQueryNode("SELECT a.* FROM BQT1.SMALLA AS a WHERE a.INTNUM = (SELECT MIN(b.INTNUM) FROM BQT1.SMALLA AS b WHERE b.INTKEY = a.IntKey ) OPTION MAKEDEP a"); //$NON-NLS-1$ //$NON-NLS-2$
        Table bvqtg1 = createUpdatableVirtualGroup("BQT_V", bvqt, bvqtn1); //$NON-NLS-1$
        TCQueryNode bvqt2n1 = new TCQueryNode("SELECT BQT2.SmallA.* FROM BQT2.SmallA, BQT_V.BQT_V WHERE BQT2.SmallA.IntKey = BQT_V.BQT_V.IntKey"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public TransformationMetadata exampleBQT() {
     ...
     * @since 4.2
     */
    public TransformationMetadata exampleMaterializedView() {
    	MetadataStore metadataStore = new MetadataStore();
        ...
        TCQueryNode vTrans = new TCQueryNode("SELECT e1 FROM MatView.MatView option NOCACHE");         //$NON-NLS-1$ //$NON-NLS-2$
        ...
        TCQueryNode vTrans2 = new TCQueryNode("SELECT x FROM matsrc");         //$NON-NLS-1$ //$NON-NLS-2$
        ...
        //covering index
        TCQueryNode vTrans3 = new TCQueryNode("SELECT x, 'z' || substring(x, 2) as y FROM matsrc");         //$NON-NLS-1$ //$NON-NLS-2$
        ...
        TCQueryNode vTrans4 = new TCQueryNode("/*+ cache(ttl:100) */ SELECT x FROM matsrc");         //$NON-NLS-1$ //$NON-NLS-2$
        ...
        //no pk
        TCQueryNode vTrans6 = new TCQueryNode("SELECT x, 'z' || substring(x, 2) as y FROM matsrc");         //$NON-NLS-1$ //$NON-NLS-2$
        ...
        //non-covering index
        TCQueryNode vTrans7 = new TCQueryNode("SELECT '1', 'z' || substring(x, 2) as y, 1 as z FROM matsrc");         //$NON-NLS-1$ //$NON-NLS-2$
	...
	public MetadataStore example1Store() {
		MetadataStore metadataStore = new MetadataStore();
		// Create models
		Schema pm1 = createPhysicalModel("pm1", metadataStore); //$NON-NLS-1$
        ...
        // Create temp groups
        Table tm1g1 = createXmlStagingTable("doc4.tm1.g1", xmltest, new TCQueryNode("select null, null, null, null, null")); //$NON-NLS-1$
		...
		TCQueryNode vm2g1n1 = new TCQueryNode("SELECT pm1.g1.* FROM pm1.g1, pm1.g2 where pm1.g1.e2 = pm1.g2.e2"); //$NON-NLS-1$ //$NON-NLS-2$
		Table vm2g1 = createUpdatableVirtualGroup("g1", vm2, vm2g1n1); //$NON-NLS-1$		
		
        TCQueryNode vm1g1n1_defect10711 = new TCQueryNode("SELECT * FROM vm1.g1 as X"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g1_defect10711 = createVirtualGroup("g1a", vm1, vm1g1n1_defect10711); //$NON-NLS-1$

        TCQueryNode vm1g1n1_defect12081 = new TCQueryNode("SELECT e1, upper(e1) as e1Upper FROM pm1.g1"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g1_defect12081 = createVirtualGroup("g1b", vm1, vm1g1n1_defect12081); //$NON-NLS-1$

        TCQueryNode vm1g1n1c = new TCQueryNode("SELECT PARSETIMESTAMP(pm1.g1.e1, 'MMM dd yyyy hh:mm:ss') as e5, e2, e3, e4 FROM pm1.g1"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g1c = createVirtualGroup("g1c", vm1, vm1g1n1c); //$NON-NLS-1$
        
        TCQueryNode vm1g2an1 = new TCQueryNode("SELECT * FROM pm1.g2"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g2a = createVirtualGroup("g2a", vm1, vm1g2an1); //$NON-NLS-1$

		TCQueryNode vm1g2n1 = new TCQueryNode("SELECT pm1.g1.e1, pm1.g1.e2, pm1.g2.e3, pm1.g2.e4 FROM pm1.g1, pm1.g2 WHERE pm1.g1.e1=pm1.g2.e1"); //$NON-NLS-1$ //$NON-NLS-2$
		Table vm1g2 = createVirtualGroup("g2", vm1, vm1g2n1); //$NON-NLS-1$

        TCQueryNode vm1g4n1 = new TCQueryNode("SELECT e1 FROM pm1.g1 UNION ALL SELECT convert(e2, string) as x FROM pm1.g2 ORDER BY e1");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g4 = createVirtualGroup("g4", vm1, vm1g4n1); //$NON-NLS-1$
	
        TCQueryNode vm1g5n1 = new TCQueryNode("SELECT concat(e1, 'val'), e2 FROM pm1.g1"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g5 = createVirtualGroup("g5", vm1, vm1g5n1); //$NON-NLS-1$

        TCQueryNode vm1g6n1 = new TCQueryNode("SELECT concat(e1, 'val') AS e, e2 FROM pm1.g1"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g6 = createVirtualGroup("g6", vm1, vm1g6n1); //$NON-NLS-1$

        TCQueryNode vm1g7n1 = new TCQueryNode("SELECT concat(e1, e2) AS e, e2 FROM pm1.g1"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g7 = createVirtualGroup("g7", vm1, vm1g7n1); //$NON-NLS-1$

        TCQueryNode vm1g8n1 = new TCQueryNode("SELECT concat(e1, 'val') AS e, e2 FROM pm1.g1 ORDER BY e"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g8 = createVirtualGroup("g8", vm1, vm1g8n1); //$NON-NLS-1$

        TCQueryNode vm1g9n1 = new TCQueryNode("SELECT pm1.g1.e1, pm1.g1.e2 FROM pm1.g1, pm4.g1 WHERE pm1.g1.e1 = pm4.g1.e1"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g9 = createVirtualGroup("g9", vm1, vm1g9n1); //$NON-NLS-1$

        TCQueryNode vm1g10n1 = new TCQueryNode("SELECT pm1.g1.e1, pm1.g1.e2 FROM pm1.g1, pm4.g2 WHERE pm1.g1.e1 = pm4.g2.e1"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g10 = createVirtualGroup("g10", vm1, vm1g10n1); //$NON-NLS-1$

        TCQueryNode vm1g11n1 = new TCQueryNode("SELECT * FROM pm4.g2"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g11 = createVirtualGroup("g11", vm1, vm1g11n1); //$NON-NLS-1$

        TCQueryNode vm1g12n1 = new TCQueryNode("SELECT DISTINCT * FROM pm3.g1"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g12 = createVirtualGroup("g12", vm1, vm1g12n1); //$NON-NLS-1$

        TCQueryNode vm1g13n1 = new TCQueryNode("SELECT DISTINCT * FROM pm3.g1 ORDER BY e1"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g13 = createVirtualGroup("g13", vm1, vm1g13n1); //$NON-NLS-1$

        TCQueryNode vm1g14n1 = new TCQueryNode("SELECT * FROM pm3.g1 ORDER BY e1"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g14 = createVirtualGroup("g14", vm1, vm1g14n1); //$NON-NLS-1$
   
        TCQueryNode vm1g15n1 = new TCQueryNode("SELECT e1, concat(e1, convert(e2, string)) AS x FROM pm3.g1"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g15 = createVirtualGroup("g15", vm1, vm1g15n1); //$NON-NLS-1$

        TCQueryNode vm1g16n1 = new TCQueryNode("SELECT concat(e1, 'val') AS e, e2 FROM pm3.g1 ORDER BY e"); //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g16 = createVirtualGroup("g16", vm1, vm1g16n1); //$NON-NLS-1$

        TCQueryNode vm1g17n1 = new TCQueryNode("SELECT pm3.g1.e1, pm3.g1.e2 FROM pm3.g1 UNION ALL SELECT pm3.g2.e1, pm3.g2.e2 FROM pm3.g2 ORDER BY e2");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g17 = createVirtualGroup("g17", vm1, vm1g17n1); //$NON-NLS-1$

        TCQueryNode vm1g18n1 = new TCQueryNode("SELECT (e4 * 100.0) as x FROM pm1.g1");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g18 = createVirtualGroup("g18", vm1, vm1g18n1); //$NON-NLS-1$

        // Transformations with subqueries and correlated subqueries
        TCQueryNode vm1g19n1 = new TCQueryNode("Select * from vm1.g4 where not (e1 in (select e1 FROM vm1.g1 WHERE vm1.g4.e1 = e1))");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g19 = createVirtualGroup("g19", vm1, vm1g19n1); //$NON-NLS-1$

        TCQueryNode vm1g20n1 = new TCQueryNode("Select * from vm1.g1 where exists (select e1 FROM vm1.g2 WHERE vm1.g1.e1 = e1)");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g20 = createVirtualGroup("g20", vm1, vm1g20n1); //$NON-NLS-1$

        TCQueryNode vm1g21n1 = new TCQueryNode("Select * from pm1.g1 where exists (select e1 FROM pm2.g1 WHERE pm1.g1.e1 = e1)");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g21 = createVirtualGroup("g21", vm1, vm1g21n1); //$NON-NLS-1$

        TCQueryNode vm1g22n1 = new TCQueryNode("Select e1, e2, e3, e4, (select e4 FROM vm1.g21 WHERE vm1.g20.e4 = e4 and e4 = 7.0) as E5 from vm1.g20");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g22 = createVirtualGroup("g22", vm1, vm1g22n1); //$NON-NLS-1$

        TCQueryNode vm1g23n1 = new TCQueryNode("Select e1, e2, e3, e4, (select e4 FROM vm1.g21 WHERE vm1.g20.e4 = 7.0 and e4 = 7.0) as E5 from vm1.g20");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g23 = createVirtualGroup("g23", vm1, vm1g23n1); //$NON-NLS-1$

        TCQueryNode vm1g24n1 = new TCQueryNode("Select * from vm1.g20 where exists (select * FROM vm1.g21 WHERE vm1.g20.e4 = E4)");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g24 = createVirtualGroup("g24", vm1, vm1g24n1); //$NON-NLS-1$

        TCQueryNode vm1g25n1 = new TCQueryNode("Select e1, e2, e3, e4, (select e4 FROM pm1.g2 WHERE e1 = 'b') as E5 from pm1.g1");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g25 = createVirtualGroup("g25", vm1, vm1g25n1); //$NON-NLS-1$

        TCQueryNode vm1g26n1 = new TCQueryNode("Select e1, e2, e3, e4, (select e4 FROM pm1.g2 WHERE e4 = pm1.g1.e4 and e1 = 'b') as E5 from pm1.g1");         //$NON-NLS-1$ //$NON-NLS-2$
...
//        QueryNode vm1g27n1 = new QueryNode("vm1.g27", "SELECT DISTINCT x as a, lower(e1) as x FROM vm1.g28");         //$NON-NLS-1$ //$NON-NLS-2$
        TCQueryNode vm1g27n1 = new TCQueryNode("SELECT upper(e1) as x, e1 FROM pm1.g1");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g27 = createVirtualGroup("g27", vm1, vm1g27n1); //$NON-NLS-1$

        TCQueryNode vm1g28n1 = new TCQueryNode("SELECT DISTINCT x as a, lower(e1) as x FROM vm1.g27");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g28 = createVirtualGroup("g28", vm1, vm1g28n1); //$NON-NLS-1$

        TCQueryNode vm1g29n1 = new TCQueryNode("SELECT DISTINCT x, lower(e1) FROM vm1.g27");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g29 = createVirtualGroup("g29", vm1, vm1g29n1); //$NON-NLS-1$

        TCQueryNode vm1g30n1 = new TCQueryNode("SELECT DISTINCT e1 as x, e1 as y FROM pm1.g1");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g30 = createVirtualGroup("g30", vm1, vm1g30n1); //$NON-NLS-1$

        TCQueryNode vm1g31n1 = new TCQueryNode("SELECT e1 as x, e1 as y FROM pm1.g1 ORDER BY x");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g31 = createVirtualGroup("g31", vm1, vm1g31n1); //$NON-NLS-1$

        TCQueryNode vm1g32n1 = new TCQueryNode("SELECT DISTINCT e1 as x, e1 as y FROM pm1.g1 ORDER BY x");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g32 = createVirtualGroup("g32", vm1, vm1g32n1); //$NON-NLS-1$

        TCQueryNode vm1g33n1 = new TCQueryNode("SELECT e2 FROM pm1.g1 WHERE 2 = e2");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g33 = createVirtualGroup("g33", vm1, vm1g33n1); //$NON-NLS-1$

        TCQueryNode vm1g34n1 = new TCQueryNode("SELECT e1 as e1_, e2 as e2_ FROM pm1.g1 UNION ALL SELECT e1 as e1_, e2 as e2_ FROM pm2.g1");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g34 = createVirtualGroup("g34", vm1, vm1g34n1); //$NON-NLS-1$

        TCQueryNode vm1g36n1 = new TCQueryNode("SELECT pm1.g1.e1 as ve1, pm1.g2.e1 as ve2 FROM pm1.g1 LEFT OUTER JOIN /* optional */ pm1.g2 on pm1.g1.e1 = pm1.g2.e1");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g36 = createVirtualGroup("g36", vm1, vm1g36n1); //$NON-NLS-1$

        TCQueryNode vm1g37n1 = new TCQueryNode("SELECT * from pm4.g1");         //$NON-NLS-1$ //$NON-NLS-2$
        ...
        TCQueryNode vm1g38n1 = new TCQueryNode("SELECT a.e1, b.e2 from pm1.g1 as a, pm6.g1 as b where a.e1=b.e1");         //$NON-NLS-1$ //$NON-NLS-2$
        Table vm1g38 = createVirtualGroup("g38", vm1, vm1g38n1); //$NON-NLS-1$
        
		// Create virtual groups
		TCQueryNode vm1g39n1 = new TCQueryNode("SELECT * FROM pm1.g1"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        TCQueryNode mc1n1 = new TCQueryNode("SELECT e1 FROM pm1.g1 UNION ALL SELECT e1 FROM pm1.g2"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        TCQueryNode vspqn1 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN DECLARE integer x; LOOP ON (SELECT e2 FROM pm1.g1) AS mycursor BEGIN x=mycursor.e2; IF(x = 15) BEGIN BREAK; END END SELECT e1 FROM pm1.g1 where pm1.g1.e2 = x; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp1 = createVirtualProcedure("vsp1", pm1, null, vspqn1); //$NON-NLS-1$\
        vsp1.setResultSet(vsprs1);

        TCQueryNode vspqn2 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN DECLARE integer x; LOOP ON (SELECT e2 FROM pm1.g1) AS mycursor BEGIN x=mycursor.e2; END SELECT e1 FROM pm1.g1; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp2 = createVirtualProcedure("vsp2", pm1, null, vspqn2); //$NON-NLS-1$
        vsp2.setResultSet(vsprs1());
        
        TCQueryNode vspqn3 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN DECLARE integer x; LOOP ON (SELECT e2 FROM pm1.g1) AS mycursor BEGIN x=mycursor.e2; END SELECT e1 FROM pm1.g1 WHERE x=e2; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp3 = createVirtualProcedure("vsp3", pm1, null, vspqn3); //$NON-NLS-1$
        vsp3.setResultSet(vsprs1());

        TCQueryNode vspqn4 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN DECLARE integer x; LOOP ON (SELECT e2 FROM pm1.g1) AS mycursor BEGIN IF(mycursor.e2 > 10) BEGIN BREAK; END x=mycursor.e2; END SELECT e1 FROM pm1.g1 WHERE x=e2; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp4 = createVirtualProcedure("vsp4", pm1, null, vspqn4); //$NON-NLS-1$
        vsp4.setResultSet(vsprs1());
        
        TCQueryNode vspqn5 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN DECLARE integer x; LOOP ON (SELECT e2 FROM pm1.g1) AS mycursor BEGIN IF(mycursor.e2 > 10) BEGIN CONTINUE; END x=mycursor.e2; END SELECT e1 FROM pm1.g1 WHERE x=e2; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp5 = createVirtualProcedure("vsp5", pm1, null, vspqn5); //$NON-NLS-1$
        vsp5.setResultSet(vsprs1());
        
        TCQueryNode vspqn6 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN DECLARE integer x; x=0; WHILE (x < 15) BEGIN x=x+1; END SELECT e1 FROM pm1.g1 WHERE x=e2; END"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        //invalid
        TCQueryNode vspqn11 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN LOOP ON (SELECT e2 FROM pm1.g1) AS mycursor BEGIN LOOP ON (SELECT e1 FROM pm1.g1) AS mycursor BEGIN END END SELECT e1 FROM pm1.g1; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp11 = createVirtualProcedure("vsp11", pm1, null, vspqn11); //$NON-NLS-1$
        vsp11.setResultSet(vsprs1());

        //invalid
        TCQueryNode vspqn12 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN DECLARE integer x; LOOP ON (SELECT e2 FROM pm1.g1) AS mycursor BEGIN END x=mycursor.e2; SELECT e1 FROM pm1.g1; END"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        TCQueryNode vspqn13 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN DECLARE string x; LOOP ON (SELECT e1 FROM pm1.g1) AS mycursor BEGIN x=mycursor.e1; END SELECT x, 5; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp13 = createVirtualProcedure("vsp13", pm1, null, vspqn13); //$NON-NLS-1$
        vsp13.setResultSet(vsprs2);

        TCQueryNode vspqn14 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT e1 INTO #temptable FROM pm1.g1; SELECT e1 FROM #temptable; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp14 = createVirtualProcedure("vsp14", pm1, null, vspqn14); //$NON-NLS-1$
        vsp14.setResultSet(vsprs1());
        
        TCQueryNode vspqn15 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT e1, e2 INTO #temptable FROM pm1.g1; SELECT #temptable.e1 FROM #temptable, pm1.g2 WHERE #temptable.e2 = pm1.g2.e2; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp15 = createVirtualProcedure("vsp15", pm1, null, vspqn15); //$NON-NLS-1$
        vsp15.setResultSet(vsprs1());
        
        TCQueryNode vspqn16 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT e1, e2 INTO #temptable FROM pm1.g1; SELECT a.e1 FROM (SELECT pm1.g2.e1 FROM #temptable, pm1.g2 WHERE #temptable.e2 = pm1.g2.e2) AS a; END"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        TCQueryNode vspqn17 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN DECLARE integer x; SELECT e1, e2 INTO #temptable FROM pm1.g1; LOOP ON (SELECT e1, e2 FROM #temptable) AS mycursor BEGIN x=mycursor.e2; END SELECT e1 FROM pm1.g1 WHERE x=e2; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp17 = createVirtualProcedure("vsp17", pm1, null, vspqn17); //$NON-NLS-1$
        vsp17.setResultSet(vsprs1());
        
        //invalid
         TCQueryNode vspqn18 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT e1 INTO temptable FROM pm1.g1; END"); //$NON-NLS-1$ //$NON-NLS-2$
         Procedure vsp18 = createVirtualProcedure("vsp18", pm1, null, vspqn18); //$NON-NLS-1$
         vsp18.setResultSet(vsprs1());

        TCQueryNode vspqn19 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT e1 INTO #temptable FROM pm1.g1; SELECT e1 INTO #temptable FROM pm1.g1; SELECT e1 FROM #temptable; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp19 = createVirtualProcedure("vsp19", pm1, null, vspqn19); //$NON-NLS-1$
        vsp19.setResultSet(vsprs1());

        TCQueryNode vspqn20 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT e1 INTO #temptable FROM pm1.g1; INSERT INTO #temptable(e1) VALUES( 'Fourth'); SELECT e1 FROM #temptable; END"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        TCQueryNode vspqn24 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT e1, e2 INTO #temptable FROM pm1.g1; SELECT #temptable.e1 FROM #temptable WHERE #temptable.e2=15; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp24 = createVirtualProcedure("vsp24", pm1, null, vspqn24); //$NON-NLS-1$
        vsp24.setResultSet(vsprs1());
 
        TCQueryNode vspqn25 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT e1 INTO #temptable FROM pm1.g1 WHERE e1 ='no match'; SELECT e1 FROM #temptable; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp25 = createVirtualProcedure("vsp25", pm1, null, vspqn25); //$NON-NLS-1$
        vsp25.setResultSet(vsprs1());

        TCQueryNode vspqn27 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT e1 from (exec pm1.vsp25())as c; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp27 = createVirtualProcedure("vsp27", pm1, null, vspqn27); //$NON-NLS-1$
        vsp27.setResultSet(vsprs1());

        TCQueryNode vspqn28 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT 0 AS e1 ORDER BY e1; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp28 = createVirtualProcedure("vsp28", pm1, null, vspqn28); //$NON-NLS-1$
        vsp28.setResultSet(vsprs1());

        TCQueryNode vspqn29 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT e1 FROM pm1.g1 ORDER BY e1; END"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        TCQueryNode vspqn39 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN DECLARE integer VARIABLES.x; VARIABLES.x=5; EXEC pm1.vsp7(VARIABLES.x); END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp39 = createVirtualProcedure("vsp39", pm1, null, vspqn39); //$NON-NLS-1$
        vsp39.setResultSet(vsprs1());

        TCQueryNode vspqn40 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN LOOP ON (SELECT e2 FROM pm1.g1) AS mycursor BEGIN EXEC pm1.vsp41(); END END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp40 = createVirtualProcedure("vsp40", pm1, null, vspqn40); //$NON-NLS-1$
        vsp40.setResultSet(vsprs1());

        TCQueryNode vspqn41 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT e1 FROM pm1.g1 where e2=15; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp41 = createVirtualProcedure("vsp41", pm1, null, vspqn41); //$NON-NLS-1$
        vsp41.setResultSet(vsprs1());

        TCQueryNode vspqn37 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN DECLARE integer x; VARIABLES.x=5; INSERT INTO vm1.g1(e2) values(VARIABLES.x); SELECT cast(ROWCOUNT as string); END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp37 = createVirtualProcedure("vsp37", pm1, null, vspqn37); //$NON-NLS-1$
        vsp37.setResultSet(vsprs1());

        TCQueryNode vspqn33 = new TCQueryNode(new StringBuffer("CREATE VIRTUAL PROCEDURE")  //$NON-NLS-1$//$NON-NLS-2$
        ...
        TCQueryNode vspqn34 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT e1, 0 AS const FROM pm1.g1 ORDER BY const; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp34 = createVirtualProcedure("vsp34", pm1, null, vspqn34); //$NON-NLS-1$
        vsp34.setResultSet(vspp4());

        TCQueryNode vspqn45 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT e1, e2 INTO #temptable FROM pm1.g1; SELECT #temptable.e1 FROM #temptable where #temptable.e1 in (SELECT pm1.g2.e1 FROM pm1.g2 ); END"); //$NON-NLS-1$ //$NON-NLS-2$
...
//        QueryNode vgvpn7 = new QueryNode("vm1.vgvp7", "SELECT P.e2 as ve1, P.e1 as ve2 FROM (EXEC pm1.vsp47(vm1.vgvp7.ve1, vm1.vgvp7.ve2)) as P"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        TCQueryNode vspqn56 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT * INTO #temptable FROM pm1.g1; SELECT #temptable.e1 FROM #temptable; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp56 = createVirtualProcedure("vsp56", pm1, null, vspqn56); //$NON-NLS-1$
        vsp56.setResultSet(vsprs1());

        TCQueryNode vspqn57 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT * INTO #temptable FROM pm1.g1; SELECT #temptable.e1 FROM #temptable order by #temptable.e1; END"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        TCQueryNode vspqn59 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN SELECT * INTO #temp FROM pm5.g3;INSERT INTO #temp (e1, e2) VALUES('integer',1); END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp59 = createVirtualProcedure("vsp59", pm6, null, vspqn59); //$NON-NLS-1$
        vsp59.setResultSet(vsprs1());
        
        TCQueryNode vspqn60 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN create local temporary table temp_table (column1 string);insert into temp_table (column1) values ('First');insert into temp_table (column1) values ('Second');insert into temp_table (column1) values ('Third');select * from temp_table; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp60 = createVirtualProcedure("vsp60", pm1, null, vspqn60); //$NON-NLS-1$
        vsp60.setResultSet(vsprs1());

        TCQueryNode vspqn61 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN create local temporary table temp_table (column1 string);insert into temp_table (column1) values ('First');drop table temp_table;create local temporary table temp_table (column1 string);insert into temp_table (column1) values ('First');insert into temp_table (column1) values ('Second');insert into temp_table (column1) values ('Third');select * from temp_table; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp61 = createVirtualProcedure("vsp61", pm1, null, vspqn61); //$NON-NLS-1$
        vsp61.setResultSet(vsprs1());
        
        TCQueryNode vspqn62 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN create local temporary table temp_table (column1 string); select e1 as column1 into temp_table from pm1.g1;select * from temp_table; END"); //$NON-NLS-1$ //$NON-NLS-2$
        Procedure vsp62 = createVirtualProcedure("vsp62", pm1, null, vspqn62); //$NON-NLS-1$
        vsp62.setResultSet(vsprs1());
        
        TCQueryNode vspqn63 = new TCQueryNode("CREATE VIRTUAL PROCEDURE BEGIN declare string o; if(1>0) begin declare string a; a='b'; o=a; end if(1>0) begin declare string a; a='c'; o=a; end  select o; END"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 */
	public KeyRecord createKey(KeyRecord.Type type, String name, Table group, List<Column> elements) {
     ...
     */
	public Schema createPhysicalModel(String name, MetadataStore metadataStore) {
     ...
     */
	public Schema createVirtualModel(String name, MetadataStore metadataStore) {
		Schema schema = new Schema();
		schema.setName(name);
     ...
     */
	public Table createPhysicalGroup(String name, Schema model, boolean fullyQualify) {
    ...
    public Table createPhysicalGroup(String name, Schema model) {
     ...
     */
	public Table createVirtualGroup(String name, Schema model, TCQueryNode plan) {
        Table table = new Table();
        table.setName(name);
        model.addTable(table);
	...
	public Table createXmlStagingTable(String name, Schema model, TCQueryNode plan) {
		Table table = createVirtualGroup(name, model, plan);
        table.setTableType(org.teiid.metadata.Table.Type.XmlStagingTable);
        return table;
	}
	
	public Table createXmlDocument(String name, Schema model, MappingDocumentImpl plan) {
		String doc = docToString(plan);
		Table table = createVirtualGroup(name, model, new TCQueryNode(doc));
		table.setTableType(org.teiid.metadata.Table.Type.Document);
		extractColumns(table, plan);
		return table;
	}
	
	private void extractColumns(final Table table, MappingDocumentImpl plan) {
		MappingVisitor mv = new MappingVisitor() {
			...
			private void addColumn(MappingNodeImpl element,
					String type) {
				if (type != null) {
	...
	public String docToString(MappingDocumentImpl plan) {
     ...
     */
	public Table createUpdatableVirtualGroup(String name, Schema model, TCQueryNode plan) {
		return createUpdatableVirtualGroup(name, model, plan, null);
	}
    
    public Table createUpdatableVirtualGroup(String name, Schema model, TCQueryNode plan, String updatePlan) {
        Table table = createVirtualGroup(name, model, plan);
     ...
     */
	public List<Column> createElements(ColumnSet<?> group, String[] names, String[] types) { 
     ...
     * Create a set of elements in batch 
     */
	public List<Column> createElementsWithDefaults(ColumnSet<?> group, String[] names, String[] types, String[] defaults) {
     ...
     */
    public Procedure createStoredProcedure(String name, Schema model, List<ProcedureParameter> params) {
     ...
     * @return Metadata object for stored procedure
     */
    public Procedure createVirtualProcedure(String name, Schema model, List<ProcedureParameter> params, TCQueryNode queryPlan) {
     ...
     * Create a result set.
     */
    public ColumnSet<Procedure> createResultSet(String name, String[] colNames, String[] colTypes) {
    ...
    public KeyRecord createAccessPattern(String name, Table group, List<Column> elements) { 
    	return createKey(org.teiid.metadata.KeyRecord.Type.AccessPattern, name, group, elements);
    }
    
    private MappingDocumentImpl exampleDoc1() {
        MappingDocumentImpl doc = new MappingDocumentImpl(getTeiidParser(), false);
        
        MappingElementImpl root = new MappingElementImpl(getTeiidParser(), "root"); //$NON-NLS-1$
        doc.addChildElement(root);
        MappingElementImpl node1 = new MappingElementImpl(getTeiidParser(), "node1"); //$NON-NLS-1$
        root.addChildElement(node1);
        MappingElementImpl node2 = new MappingElementImpl(getTeiidParser(), "node2"); //$NON-NLS-1$
        node1.addChildElement(node2);
        MappingElementImpl node3 = new MappingElementImpl(getTeiidParser(), "node3"); //$NON-NLS-1$
        node2.addChildElement(node3);
        return doc;
    }

    private MappingDocumentImpl exampleDoc2() {
        MappingDocumentImpl doc = new MappingDocumentImpl(getTeiidParser(), false);
        ...
        MappingElementImpl node1 = new MappingElementImpl(getTeiidParser(), "node1"); //$NON-NLS-1$
        root.addChildElement(node1);
        MappingSequenceNodeImpl node2 = new MappingSequenceNodeImpl(getTeiidParser());
        node1.addSequenceNode(node2);
        MappingElementImpl node3 = new MappingElementImpl(getTeiidParser(), "node3"); //$NON-NLS-1$
        node2.addChildElement(node3);
        MappingElementImpl node2a = new MappingElementImpl(getTeiidParser(), "node2"); //$NON-NLS-1$
        root.addChildElement(node2a);
        return doc;
    }

    // has ambiguous short and long names
    private MappingDocumentImpl exampleDoc3() {
        MappingDocumentImpl doc = new MappingDocumentImpl(getTeiidParser(), false);
        MappingElementImpl root = new MappingElementImpl(getTeiidParser(), "root"); //$NON-NLS-1$
        doc.addChildElement(root);
    ...
    private MappingDocumentImpl exampleDoc4() {
        ...
        root.addAttribute(new MappingAttributeImpl(getTeiidParser(), "node6")); //$NON-NLS-1$
        root.addStagingTable("xmltest.doc4.tm1.g1"); //$NON-NLS-1$
        
        MappingElementImpl node1 = new MappingElementImpl(getTeiidParser(), "node1"); //$NON-NLS-1$
        root.addChildElement(node1);
        node1.addAttribute(new MappingAttributeImpl(getTeiidParser(), "node2")); //$NON-NLS-1$

        MappingElementImpl node3 = new MappingElementImpl(getTeiidParser(), "node3"); //$NON-NLS-1$
        root.addChildElement(node3);
        node3.addAttribute(new MappingAttributeImpl(getTeiidParser(), "node4")); //$NON-NLS-1$
        
        MappingElementImpl node5 = new MappingElementImpl(getTeiidParser(), "node4"); //$NON-NLS-1$
        node3.addChildElement(node5);
        MappingElementImpl duplicateRoot = new MappingElementImpl(getTeiidParser(), "root"); //$NON-NLS-1$
        node5.addChildElement(duplicateRoot);

        duplicateRoot.addChildElement(new MappingElementImpl(getTeiidParser(), "node6")); //$NON-NLS-1$        
        return doc;
    }    

    // has a union in the mapping class
    private MappingDocumentImpl exampleDoc5() {
        MappingDocumentImpl doc = new MappingDocumentImpl(getTeiidParser(), false);
        MappingElementImpl root = new MappingElementImpl(getTeiidParser(), "root"); //$NON-NLS-1$
        doc.addChildElement(root);
        ...
        MappingElementImpl node1 = new MappingElementImpl(getTeiidParser(), "node1"); //$NON-NLS-1$
        root.addChildElement(node1);
        node1.addChildElement(new MappingElementImpl(getTeiidParser(), "node2","xmltest.mc1.e1")); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private MappingDocumentImpl exampleDoc6() {
        MappingDocumentImpl doc = new MappingDocumentImpl(getTeiidParser(), false);
        MappingElementImpl root = new MappingElementImpl(getTeiidParser(), "root"); //$NON-NLS-1$
        doc.addChildElement(root);

        root.addChildElement(new MappingElementImpl(getTeiidParser(), "node")); //$NON-NLS-1$
        root.addChildElement(new MappingElementImpl(getTeiidParser(), "thenode")); //$NON-NLS-1$
        return doc;
    }

	public VDBMetaData example1VDB() {
	...
	public VDBMetaData exampleBQTVDB() {
		VDBMetaData vdb = new VDBMetaData();
		vdb.setName("example1");
		vdb.setVersion(1);
	...
	public VDBMetaData exampleMultiBindingVDB() {
		VDBMetaData vdb = new VDBMetaData();
	...
	public ModelMetaData createModel(String name, boolean source) {
		ModelMetaData model = new ModelMetaData();
		model.setName(name);
		if (source) {
			model.setModelType(Model.Type.PHYSICAL);
	...
	public TransformationMetadata exampleBitwise() { 
	...
	public void setCardinality(String group, int cardinality, QueryMetadataInterface metadata) throws Exception {
	...
	public TransformationMetadata exampleAggregatesCached() {
	    return CACHED_AGGREGATES;
	}

	public TransformationMetadata example3() {
		MetadataStore metadataStore = new MetadataStore();
		// Create models
		Schema pm1 = createPhysicalModel("pm1", metadataStore); //$NON-NLS-1$
		Schema pm2 = createPhysicalModel("pm2", metadataStore); //$NON-NLS-1$
	...
	public TransformationMetadata exampleUpdateProc(Table.TriggerEvent event, String procedure) {
		MetadataStore metadataStore = new MetadataStore();
		// Create models
		Schema pm1 = createPhysicalModel("pm1", metadataStore); //$NON-NLS-1$
		Schema pm2 = createPhysicalModel("pm2", metadataStore); //$NON-NLS-1$
		...
		TCQueryNode vm1g2n1 = new TCQueryNode("SELECT pm1.g2.e1, pm1.g2.e2, pm1.g2.e3 FROM pm1.g2"); //$NON-NLS-1$ //$NON-NLS-2$
		Table vm1g2 = createUpdatableVirtualGroup("g2", vm1, vm1g2n1); //$NON-NLS-1$
	
		TCQueryNode vm1g3n1 = new TCQueryNode("SELECT CONCAT(e1, 'm') as x, (e2 +1) as y, 1 as e3, e4*50 as e4 FROM pm1.g1"); //$NON-NLS-1$ //$NON-NLS-2$
		Table vm1g3 = createUpdatableVirtualGroup("g3", vm1, vm1g3n1); //$NON-NLS-1$
	
		TCQueryNode vm1g4n1 = new TCQueryNode("SELECT * FROM pm1.g1"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void setInsteadOfTriggerDefinition(Table view, TriggerEvent event, String proc) {
		switch (event) {
		case DELETE:
	...
	public TransformationMetadata exampleUpdateProc(TriggerEvent procedureType, String procedure1, String procedure2) {
		MetadataStore metadataStore = new MetadataStore();
	    // Create models
	    Schema pm1 = createPhysicalModel("pm1", metadataStore); //$NON-NLS-1$
	    Schema pm2 = createPhysicalModel("pm2", metadataStore); //$NON-NLS-1$
	    ...
	    TCQueryNode vm1g2n1 = new TCQueryNode("SELECT pm1.g2.e1, pm1.g2.e2, pm1.g2.e3, pm1.g2.e4 FROM pm1.g2"); //$NON-NLS-1$ //$NON-NLS-2$
	    Table vm1g2 = createUpdatableVirtualGroup("g2", vm1, vm1g2n1); //$NON-NLS-1$
	...
	public TransformationMetadata exampleBusObj() {
	    // Create the facade from the store
	    return createTransformationMetadata(exampleBusObjStore(), "busObj");
	}
	
	public MetadataStore exampleBusObjStore() { 
		MetadataStore metadataStore = new MetadataStore();
	    // Create db2 tables
	    ...
	    TCQueryNode n1 = new TCQueryNode("select sum(c0) as c0, c1, c2 from db2Table group by c1, c2"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public TransformationMetadata exampleAggregates() { 
	    MetadataStore store = new MetadataStore();
	...
	public void addAggregateTablesToModel(String modelName, MetadataStore metadataStore) {
	    // Create db2 tables
	 ...
	 * @since 4.2
	 */
	public TransformationMetadata exampleMultiBinding() {
		MetadataStore metadataStore = new MetadataStore();
	 ...
	 * @return
	 */
	public TransformationMetadata exampleCase3225() {
		MetadataStore metadataStore = new MetadataStore();
	    ...
	    TCQueryNode rsQuery2 = new TCQueryNode("SELECT stock.suppliers.supplierNum, supplierName, supplierZipCode, stock.item_supplier.itemNum FROM stock.suppliers, stock.item_supplier WHERE stock.suppliers.supplierNum = stock.item_supplier.supplierNum AND stock.item_supplier.itemNum = ?"); //$NON-NLS-1$ //$NON-NLS-2$
	    ...
	    TCQueryNode rsQuery3 = new TCQueryNode("SELECT orderNum, orderDate, orderQty, orderStatus, itemFK, supplierFK FROM stock.orders WHERE itemFK = ? AND supplierFK = ?"); //$NON-NLS-1$ //$NON-NLS-2$
	    ...
	    TCQueryNode rsQuery4 = new TCQueryNode("SELECT employeeNum, firstName, lastName, supervisorNum, specializesInItemNum, supplierNumFK FROM stock.employees WHERE specializesInItemNum = ? AND supplierNumFK = ?"); //$NON-NLS-1$ //$NON-NLS-2$
	    ...
	    // MAPPING DOC ======================================================================
	    MappingDocumentImpl doc = new MappingDocumentImpl(getTeiidParser(), false);
	    MappingElementImpl root = new MappingElementImpl(getTeiidParser(), "Catalogs"); //$NON-NLS-1$
        doc.addChildElement(root);
	    
	    MappingElementImpl cats = new MappingElementImpl(getTeiidParser(), "Catalog"); //$NON-NLS-1$
	    root.addChildElement(cats);
	    MappingElementImpl itemsA = new MappingElementImpl(getTeiidParser(), "Items"); //$NON-NLS-1$
	    cats.addChildElement(itemsA);

	    MappingElementImpl item = new MappingElementImpl(getTeiidParser(), "Item"); //$NON-NLS-1$
	    itemsA.addChildElement(item);

	    item.setSource("xmltest.items");//$NON-NLS-1$
	    item.setMaxOccurrs(-1);
	    item.addAttribute(new MappingAttributeImpl(getTeiidParser(), "ItemID", "xmltest.items.itemNum")); //$NON-NLS-1$ //$NON-NLS-2$
	    item.addChildElement(new MappingElementImpl(getTeiidParser(), "Name", "xmltest.items.itemName")); //$NON-NLS-1$ //$NON-NLS-2$
	    item.addChildElement(new MappingElementImpl(getTeiidParser(), "Quantity", "xmltest.items.itemQuantity")); //$NON-NLS-1$ //$NON-NLS-2$
	    
	    //NESTED STUFF======================================================================
	    MappingElementImpl nestedWrapper = new MappingElementImpl(getTeiidParser(), "Suppliers"); //$NON-NLS-1$
	    item.addChildElement(nestedWrapper);
	    MappingElementImpl supplier = new MappingElementImpl(getTeiidParser(), "Supplier"); //$NON-NLS-1$
	    nestedWrapper.addChildElement(supplier);
	    supplier.setSource("xmltest.suppliers");//$NON-NLS-1$
	    supplier.setMaxOccurrs(-1);
	    supplier.addAttribute(new MappingAttributeImpl(getTeiidParser(), "SupplierID", "xmltest.suppliers.supplierNum")); //$NON-NLS-1$ //$NON-NLS-2$
	    supplier.addChildElement(new MappingElementImpl(getTeiidParser(), "Name","xmltest.suppliers.supplierName")); //$NON-NLS-1$ //$NON-NLS-2$
	    supplier.addChildElement(new MappingElementImpl(getTeiidParser(), "Zip", "xmltest.suppliers.supplierZipCode")); //$NON-NLS-1$ //$NON-NLS-2$
	    
	    MappingElementImpl ordersWrapper = new MappingElementImpl(getTeiidParser(), "Orders"); //$NON-NLS-1$
	    supplier.addChildElement(ordersWrapper);
	    MappingElementImpl order = new MappingElementImpl(getTeiidParser(), "Order"); //$NON-NLS-1$
	    ordersWrapper.addChildElement(order);
	    order.setSource("xmltest.orders"); //$NON-NLS-1$
	    order.setMaxOccurrs(-1);
	    order.addAttribute(new MappingAttributeImpl(getTeiidParser(), "OrderID", "xmltest.orders.orderNum")); //$NON-NLS-1$ //$NON-NLS-2$
	    order.addChildElement(new MappingElementImpl(getTeiidParser(), "OrderDate", "xmltest.orders.orderDate")); //$NON-NLS-1$ //$NON-NLS-2$
	    order.addChildElement(new MappingElementImpl(getTeiidParser(), "OrderQuantity", "xmltest.orders.orderQty")); //$NON-NLS-1$ //$NON-NLS-2$
	
	    MappingElementImpl orderStatus = new MappingElementImpl(getTeiidParser(), "OrderStatus", "xmltest.orders.orderStatus"); //$NON-NLS-1$ //$NON-NLS-2$
	    order.addChildElement(orderStatus);
	    orderStatus.setMinOccurrs(0);                
	    //NESTED STUFF======================================================================
	    
	    MappingElementImpl employeesWrapper = new MappingElementImpl(getTeiidParser(), "Employees"); //$NON-NLS-1$
	    supplier.addChildElement(employeesWrapper);
	    MappingElementImpl employee = new MappingElementImpl(getTeiidParser(), "Employee"); //$NON-NLS-1$
	    employeesWrapper.addChildElement(employee);
	    employee.setSource("xmltest.employees"); //$NON-NLS-1$
	    employee.setMaxOccurrs(-1);
	    employee.addAttribute(new MappingAttributeImpl(getTeiidParser(), "EmployeeID", "xmltest.employees.employeeNum")); //$NON-NLS-1$ //$NON-NLS-2$
	    employee.addChildElement(new MappingElementImpl(getTeiidParser(), "FirstName", "xmltest.employees.firstName")); //$NON-NLS-1$ //$NON-NLS-2$
	    employee.addChildElement(new MappingElementImpl(getTeiidParser(), "LastName", "xmltest.employees.lastName")); //$NON-NLS-1$ //$NON-NLS-2$
	    employee.addAttribute(new MappingAttributeImpl(getTeiidParser(), "SupervisorID", "xmltest.employees.supervisorNum")); //$NON-NLS-1$ //$NON-NLS-2$
	    ...
	    TCQueryNode playersNode = new TCQueryNode("SELECT stock.employees.employeeNum, firstName, lastName, supervisorNum FROM stock.employees WHERE specializesInItemNum is not null"); //$NON-NLS-1$ //$NON-NLS-2$
	    Table rsPlayers = createVirtualGroup("player", xmltest, playersNode); //$NON-NLS-1$
	
	    TCQueryNode managersNode = new TCQueryNode("SELECT stock.employees.employeeNum, firstName, lastName, supervisorNum FROM stock.employees WHERE stock.employees.employeeNum = ?"); //$NON-NLS-1$ //$NON-NLS-2$
	    ...
	    TCQueryNode ownersNode = new TCQueryNode("SELECT stock.employees.employeeNum, firstName, lastName, supervisorNum FROM stock.employees WHERE stock.employees.employeeNum = ?"); //$NON-NLS-1$ //$NON-NLS-2$ 
	    ...
	    MappingDocumentImpl doc2 = new MappingDocumentImpl(getTeiidParser(), false);
	    MappingElementImpl root2 = new MappingElementImpl(getTeiidParser(), "BaseballPlayers"); //$NON-NLS-1$
        doc2.addChildElement(root);
	    
	    MappingElementImpl player = new MappingElementImpl(getTeiidParser(), "Player"); //$NON-NLS-1$
	    root2.addChildElement(player);
	    player.setSource("xmltest.player"); //$NON-NLS-1$
	    player.setMaxOccurrs(-1);
	    player.addAttribute(new MappingAttributeImpl(getTeiidParser(), "PlayerID", "xmltest.player.employeeNum")); //$NON-NLS-1$ //$NON-NLS-2$
	    player.addChildElement(new MappingElementImpl(getTeiidParser(), "FirstName", "xmltest.player.firstName")); //$NON-NLS-1$ //$NON-NLS-2$
	    player.addChildElement(new MappingElementImpl(getTeiidParser(), "LastName", "xmltest.player.lastName")); //$NON-NLS-1$ //$NON-NLS-2$
	
	    MappingElementImpl manager = new MappingElementImpl(getTeiidParser(), "Manager"); //$NON-NLS-1$
	    player.addChildElement(manager);
	    manager.setSource("xmltest.managers");//$NON-NLS-1$
	    manager.setMaxOccurrs(-1);
	    manager.addAttribute(new MappingAttributeImpl(getTeiidParser(), "ManagerID", "xmltest.managers.employeeNum")); //$NON-NLS-1$ //$NON-NLS-2$
	    manager.addChildElement(new MappingElementImpl(getTeiidParser(), "FirstName", "xmltest.managers.firstName")); //$NON-NLS-1$ //$NON-NLS-2$
	    manager.addChildElement(new MappingElementImpl(getTeiidParser(), "LastName", "xmltest.managers.lastName")); //$NON-NLS-1$ //$NON-NLS-2$
	            
	    MappingElementImpl owner = new MappingElementImpl(getTeiidParser(), "Owner"); //$NON-NLS-1$
	    manager.addChildElement(owner);
	    owner.setSource("xmltest.owners"); //$NON-NLS-1$
	    owner.setMaxOccurrs(-1);
	    owner.addAttribute(new MappingAttributeImpl(getTeiidParser(), "OwnerID", "xmltest.owners.employeeNum")); //$NON-NLS-1$ //$NON-NLS-2$
	    owner.addChildElement(new MappingElementImpl(getTeiidParser(), "FirstName", "xmltest.owners.firstName")); //$NON-NLS-1$ //$NON-NLS-2$
	    owner.addChildElement(new MappingElementImpl(getTeiidParser(), "LastName", "xmltest.owners.lastName")); //$NON-NLS-1$ //$NON-NLS-2$       
	    // END MAPPING DOC ======================================================================
	 ...
	 */
	public TransformationMetadata example4() {
		MetadataStore metadataStore = new MetadataStore();
		...
		TCQueryNode vm1g3n1 = new TCQueryNode("SELECT pm1.g3.e1 AS x, pm1.g3.e2 AS y from pm1.g3"); //$NON-NLS-1$ //$NON-NLS-2$
		Table vm1g3 = createUpdatableVirtualGroup("g3", vm1, vm1g3n1); //$NON-NLS-1$
	
	    TCQueryNode vm1g4n1 = new TCQueryNode("SELECT distinct pm1.g2.e1 as ve1, pm1.g1.e1 as ve2 FROM pm1.g2 LEFT OUTER JOIN /* optional */ pm1.g1 on pm1.g1.e1 = pm1.g2.e1");         //$NON-NLS-1$ //$NON-NLS-2$
	    Table vm1g4 = createVirtualGroup("g4", vm1, vm1g4n1); //$NON-NLS-1$
	    createElements(vm1g4,
	              new String[] { "ve1", "ve2" }, //$NON-NLS-1$ //$NON-NLS-2$
	              new String[] { DefaultDataTypeManager.DefaultDataTypes.STRING.getId(), DefaultDataTypeManager.DefaultDataTypes.STRING.getId() });
