...
public class Test8SqlNodeVisitor extends AbstractTestSqlNodeVisitor {
    ...
    public void testAggregateSymbol1() {
        AggregateSymbol agg = getFactory().newAggregateSymbol("COUNT", false, getFactory().newConstant("abc"));
        helpTest(agg, "COUNT('abc')");
    }

    @Test
    public void testAggregateSymbol2() {
        AggregateSymbol agg = getFactory().newAggregateSymbol("COUNT", true, getFactory().newConstant("abc"));
        helpTest(agg, "COUNT(DISTINCT 'abc')");
    }

    @Test
    public void testAggregateSymbol3() {
        AggregateSymbol agg = getFactory().newAggregateSymbol("COUNT", false, null);
        helpTest(agg, "COUNT(*)");
    }

    @Test
    public void testAggregateSymbol4() {
        AggregateSymbol agg = getFactory().newAggregateSymbol("AVG", false, getFactory().newConstant("abc"));
        helpTest(agg, "AVG('abc')");
    }

    @Test
    public void testAggregateSymbol5() {
        AggregateSymbol agg = getFactory().newAggregateSymbol("SUM", false, getFactory().newConstant("abc"));
        helpTest(agg, "SUM('abc')");
    }

    @Test
    public void testAggregateSymbol6() {
        AggregateSymbol agg = getFactory().newAggregateSymbol("MIN", false, getFactory().newConstant("abc"));
        helpTest(agg, "MIN('abc')");
    }

    @Test
    public void testAggregateSymbol7() {
        AggregateSymbol agg = getFactory().newAggregateSymbol("MAX", false, getFactory().newConstant("abc"));
