...
//        assertEquals("SQL strings do not match: ", expectedString, actualString);
 ...
 // ======================== Joins ===============================================
    ...
    public void testCompoundHaving() {
        ...
        CompoundCriteria having = getFactory().newCompoundCriteria(ICompoundCriteria.AND,
    ...
    public void testIsNullCriteria1() {
        ...
        Criteria crit = getFactory().newIsNullCriteria(getFactory().newObject(a));
    ...
    public void testIsNullCriteria2() {
        ...
        IsNullCriteria crit = getFactory().newIsNullCriteria(getFactory().newObject(a));
    ...
    public void testNotIsNullCriteria() {
        ...
        Criteria crit = getFactory().newNotCriteria(getFactory().newIsNullCriteria(getFactory().newObject(a)));
    ...
    public void testStringNotEqualDoubleTicks() {
        ...
        Criteria crit = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.NE, ex);
    ...
    public void testNotEquals2() {
        ...
        Criteria crit = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.NE, constant);
    ...
    public void testPartlyQuotedGroup() {
        ...
        Criteria crit = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.EQ, getFactory().newConstant(new Integer(5)));
    ...
    public void testBetween1() {
        ...
        Criteria crit = getFactory().newBetweenCriteria(getFactory().newObject(a), constant1, constant2);
    ...
    public void testBetween2() {
        ...
        Expression constant1 = getFactory().newConstant(new Integer(1000));
        Expression constant2 = getFactory().newConstant(new Integer(2000));
        BetweenCriteria crit = getFactory().newBetweenCriteria(getFactory().newObject(a), constant1, constant2);
        crit.setNegated(true);
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
    ...
    public void testCompareLT() {
        ...
        Criteria crit = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.LT, constant);
    ...
    public void testCompareGT() {
        ...
        Expression constant = getFactory().newConstant(new Integer(1000));
        Criteria crit = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.GT, constant);
    ...
    public void testCompareLE() {
        ...
        Expression constant = getFactory().newConstant(new Integer(1000));
        Criteria crit = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.LE, constant);
    ...
    public void testCompareGE() {
        ...
        Expression constant = getFactory().newConstant(new Integer(1000));
        Criteria crit = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.GE, constant);
    ...
    protected void helpTestCompoundCompare(String testSQL) {
        ...
        Expression constant = getFactory().newConstant(new Integer(1000));
        Criteria crit2 = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.EQ, constant);
        Criteria crit = getFactory().newCompoundCriteria(ICompoundCriteria.AND, crit1, crit2);
    ...
    public void testOrInSelect() {
        Query query = getFactory().newQuery();
        CompoundCriteria compoundCriteria = getFactory().newCompoundCriteria(ICompoundCriteria.OR,
    ...
    public void testLikeWOConstant() {
        ...
        Criteria crit = getFactory().newMatchCriteria(getFactory().newObject(a), x);
    ...
    public void testAssignStatement() throws Exception {
        ...
        AssignmentStatement queryStmt = getFactory().newAssignmentStatement(getFactory().newObject(a), query);
        AssignmentStatement exprStmt = getFactory().newAssignmentStatement(getFactory().newObject(a), expr);
    ...
    public void testLoopStatement() throws Exception {
        ...
        Statement assignmentStmt = getFactory().newAssignmentStatement(getFactory().newObject(x), c1);
    ...
    public void testWhileStatement() throws Exception {
        ...
        Statement assignmentStmt = getFactory().newAssignmentStatement(getFactory().newObject(x), f);
        Block block = getFactory().newBlock();
        block.addStatement(assignmentStmt);
        Criteria crit = getFactory().newCompareCriteria(getFactory().newObject(x), Operator.LT, getFactory().newConstant(new Integer(100)));
    ...
    public void testAndOrPrecedence_1575() {
        ...
        CompoundCriteria cc1 = getFactory().newCompoundCriteria(ICompoundCriteria.AND, c2, c3);
        CompoundCriteria cc2 = getFactory().newCompoundCriteria(ICompoundCriteria.OR, c1, cc1);
        Query q = getFactory().newQuery();
        q.setSelect(s);
        q.setFrom(f);
        q.setCriteria(cc2);
    ...
    public void testAndOrPrecedence2_1575() {
        ...
        CompareCriteria c2 = getFactory().newCompareCriteria(getFactory().newElementSymbol("e2"), Operator.EQ, getFactory().newConstant(new Integer(1)));
        CompareCriteria c3 = getFactory().newCompareCriteria(getFactory().newElementSymbol("e3"), Operator.EQ, getFactory().newConstant(new Integer(3)));
        CompoundCriteria cc1 = getFactory().newCompoundCriteria(ICompoundCriteria.AND, c1, c2);
        CompoundCriteria cc2 = getFactory().newCompoundCriteria(ICompoundCriteria.OR, cc1, c3);
        Query q = getFactory().newQuery();
        q.setSelect(s);
        q.setFrom(f);
        q.setCriteria(cc2);
    ...
    protected void helpTestCompoundNonJoinCriteria(String sqlPred, Criteria predCrit) {
        ...
        CompareCriteria c1 = getFactory().newCompareCriteria(getFactory().newElementSymbol("e1"), Operator.EQ, getFactory().newConstant(new Integer(0)));
        CompoundCriteria cc1 = getFactory().newCompoundCriteria(ICompoundCriteria.AND, c1, predCrit);
    ...
    public void testElementInDoubleQuotes_Update() throws Exception {
        ...
        SetClause setClause = getFactory().newSetClause(e, getFactory().newConstant("bar", String.class));        
        SetClauseList setClauseList = getFactory().newSetClauseList();
    ...
    public void testXmlAggWithOrderBy() throws Exception {
        ...
        AggregateSymbol as = getFactory().newAggregateSymbol("xmlAgg", false, getFactory().newConstant(1));
    ...
    public void testTextAggWithOrderBy() throws Exception {
        ...
        AggregateSymbol as = getFactory().newAggregateSymbol("TextAgg", false, tf);
        as.setOrderBy(getFactory().newOrderBy(Arrays.asList(getFactory().newElementSymbol("e2"))));
    ...
    public void testArrayAggWithOrderBy() throws Exception {
        ...
        AggregateSymbol as = getFactory().newAggregateSymbol("array_agg", false, getFactory().newConstant(1));
        as.setOrderBy(getFactory().newOrderBy(Arrays.asList(getFactory().newElementSymbol("e2"))));
        Query query = getFactory().newQuery();
        query.setSelect(getFactory().newSelect(Arrays.asList(as)));
