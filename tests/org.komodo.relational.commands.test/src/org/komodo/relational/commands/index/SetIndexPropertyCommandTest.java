...
public class SetIndexPropertyCommandTest extends AbstractCommandTest {
    ...
    /**
	 * Test for SetIndexPropertyCommand
	 */
	public SetIndexPropertyCommandTest( ) {
		super();
	}
    ...
    public void testSetProperty1() throws Exception {
        ...
        setup(cmdFile.getAbsolutePath(), SetIndexPropertyCommand.class);
        ...
        assertEquals("myExpression", indexes[0].getExpression(uow));  //$NON-NLS-1$
    }
