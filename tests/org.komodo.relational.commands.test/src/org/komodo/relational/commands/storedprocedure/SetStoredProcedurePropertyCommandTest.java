...
public class SetStoredProcedurePropertyCommandTest extends AbstractCommandTest {
    ...
    /**
	 * Test for SetStoredProcedurePropertyCommand
	 */
	public SetStoredProcedurePropertyCommandTest( ) {
		super();
	}
    ...
    public void testSetProperty1() throws Exception {
        ...
        setup(cmdFile.getAbsolutePath(), SetStoredProcedurePropertyCommand.class);
        ...
        assertEquals("myNameInSource", ((StoredProcedure)procs[0]).getNameInSource(uow)); //$NON-NLS-1$
    }
