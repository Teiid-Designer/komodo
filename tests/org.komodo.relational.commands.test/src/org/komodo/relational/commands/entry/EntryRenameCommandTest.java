...
/**
 * Test Class to test {@link EntryRenameCommand}.
 */
@Ignore //  Cannot create entry in VDB Builder
@SuppressWarnings( { "javadoc",
                     "nls" } )
public final class EntryRenameCommandTest extends AbstractCommandTest {
