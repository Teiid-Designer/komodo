...
public class UnsetTablePropertyCommandTest extends AbstractCommandTest {
    ...
    public void testUnsetProperty1() throws Exception {
        ...
        writer.write("unset-property CARDINALITY" + NEW_LINE);  //$NON-NLS-1$
        writer.close();
        
        setup(cmdFile.getAbsolutePath(), UnsetTablePropertyCommand.class);
        ...
        assertEquals(-1, tables[0].getCardinality(uow));
    }
