...
public class DeleteViewCommandTest extends AbstractCommandTest {
    ...
    public void testDelete1() throws Exception {
        ...
        writer.write("add-view myView1" + NEW_LINE);  //$NON-NLS-1$
        writer.write("add-view myView2" + NEW_LINE);  //$NON-NLS-1$
        writer.write("delete-view myView1" + NEW_LINE);  //$NON-NLS-1$
        writer.close();
        
        setup(cmdFile.getAbsolutePath(), DeleteViewCommand.class);
        ...
        assertEquals("myView2", views[0].getName(uow)); //$NON-NLS-1$
    }
