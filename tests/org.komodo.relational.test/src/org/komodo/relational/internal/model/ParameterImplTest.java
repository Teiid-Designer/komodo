...
public final class ParameterImplTest extends RelationalModelTest {
    ...
    public void init() throws Exception {
        ...
        this.parameter = RelationalModelFactory.createParameter(null, _repo, this.parent, NAME);
    }
    ...
    public void shouldHaveDirectionPropertyDefaultValueAfterConstruction() throws Exception {
        ...
        assertThat(this.parameter.getProperty(null, TeiidDdlLexicon.CreateProcedure.PARAMETER_TYPE).getStringValue(),
    ...
    public void shouldHaveNullablePropertyDefaultValueAfterConstruction() throws Exception {
        ...
        assertThat(this.parameter.getProperty(null, StandardDdlLexicon.NULLABLE).getStringValue(),
    ...
    public void shouldHaveParentProcedureAfterConstruction() throws Exception {
        assertThat(this.parameter.getProcedure(null), is(this.parent));
    }
    ...
    public void shouldSetDatatypeLengthProperty() throws Exception {
        ...
        assertThat(this.parameter.getProperty(null, StandardDdlLexicon.DATATYPE_LENGTH).getLongValue(), is(value));
    }
    ...
    public void shouldSetDatatypeNameProperty() throws Exception {
        ...
        assertThat(this.parameter.getProperty(null, StandardDdlLexicon.DATATYPE_NAME).getStringValue(), is(value));
    }
    ...
    public void shouldSetDatatypePrecisionProperty() throws Exception {
        ...
        assertThat(this.parameter.getProperty(null, StandardDdlLexicon.DATATYPE_PRECISION).getLongValue(), is((long)value));
    }
    ...
    public void shouldSetDatatypeScaleProperty() throws Exception {
        ...
        assertThat(this.parameter.getProperty(null, StandardDdlLexicon.DATATYPE_SCALE).getLongValue(), is((long)value));
    }
    ...
    public void shouldSetDefaultValueProperty() throws Exception {
        ...
        assertThat(this.parameter.getProperty(null, StandardDdlLexicon.DEFAULT_VALUE).getStringValue(), is(value));
    }
    ...
    public void shouldSetNullableProperty() throws Exception {
        ...
        assertThat(this.parameter.getProperty(null, StandardDdlLexicon.NULLABLE).getStringValue(), is(value.toString()));
    }
