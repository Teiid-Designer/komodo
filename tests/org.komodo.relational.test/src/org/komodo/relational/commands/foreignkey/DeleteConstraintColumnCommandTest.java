...
import org.komodo.relational.commands.tableconstraint.DeleteConstraintColumnCommand;
...
public class DeleteConstraintColumnCommandTest extends AbstractCommandTest {
    ...
    public void testDelete1() throws Exception {
        ...
        writer.write("add-parameter myParameter1" + NEW_LINE);  //$NON-NLS-1$
        writer.write("add-parameter myParameter2" + NEW_LINE);  //$NON-NLS-1$
        writer.write("delete-parameter myParameter1" + NEW_LINE);  //$NON-NLS-1$
        writer.close();

        setup(cmdFile.getAbsolutePath(), DeleteConstraintColumnCommand.class);
        ...
        assertEquals("myParameter2", params[0].getName(uow)); //$NON-NLS-1$
    }
