...
/**
 * Test Class to test UnsetConditionPropertyCommand
 *
 */
@SuppressWarnings("javadoc")
public class UnsetConditionPropertyCommandTest extends AbstractCommandTest {

	private static final String UNSET_CONDITION_PROPERTY_COMMAND_1 = "unsetConditionPropertyCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testUnsetProperty1() throws Exception {
    	setup(UNSET_CONDITION_PROPERTY_COMMAND_1, UnsetConditionPropertyCommand.class);
