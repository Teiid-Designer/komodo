...
public class SetPermissionPropertyCommandTest extends AbstractCommandTest {
	...
	private static final String SET_PERMISSION_PROPERTY_COMMAND_1 = "setPermissionPropertyCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for SetPermissionPropertyCommand
	 */
	public SetPermissionPropertyCommandTest( ) {
		super();
	}

    @Test
    public void testSetProperty1() throws Exception {
        setup(SET_PERMISSION_PROPERTY_COMMAND_1, SetPermissionPropertyCommand.class);
