...
public class AddMaskCommandTest extends AbstractCommandTest {
	...
	private static final String ADD_MASK_COMMAND_1 = "addMaskCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for AddMaskCommand
	 */
	public AddMaskCommandTest( ) {
		super();
	}

    @Test
    public void testAdd1() throws Exception {
        setup(ADD_MASK_COMMAND_1, AddMaskCommand.class);
