...
public class DeleteDataRoleCommandTest extends AbstractCommandTest {
	...
	private static final String DELETE_DATA_ROLE_COMMAND_1 = "deleteDataRoleCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testDelete1() throws Exception {
        setup(DELETE_DATA_ROLE_COMMAND_1, DeleteDataRoleCommand.class);
