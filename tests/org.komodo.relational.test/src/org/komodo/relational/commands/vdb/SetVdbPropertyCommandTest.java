...
public class SetVdbPropertyCommandTest extends AbstractCommandTest {
	...
	private static final String SET_VDB_PROPERTY_COMMAND_1 = "setVdbPropertyCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testSetProperty1() throws Exception {
        setup(SET_VDB_PROPERTY_COMMAND_1, SetVdbPropertyCommand.class);
