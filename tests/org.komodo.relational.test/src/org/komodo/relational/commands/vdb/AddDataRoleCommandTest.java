...
public class AddDataRoleCommandTest extends AbstractCommandTest {
	...
	private static final String ADD_DATA_ROLE_COMMAND_1 = "addDataRoleCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for AddDataRoleCommand
	 */
	public AddDataRoleCommandTest( ) {
		super();
	}

    @Test
    public void testAdd1() throws Exception {
        setup(ADD_DATA_ROLE_COMMAND_1, AddDataRoleCommand.class);
