...
public class DeleteTranslatorCommandTest extends AbstractCommandTest {
	...
	private static final String DELETE_TRANSLATOR_COMMAND_1 = "deleteTranslatorCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testDelete1() throws Exception {
        setup(DELETE_TRANSLATOR_COMMAND_1, DeleteTranslatorCommand.class);
