...
public class AddTranslatorCommandTest extends AbstractCommandTest {
	...
	private static final String ADD_TRANSLATOR_COMMAND_1 = "addTranslatorCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for AddTranslatorCommand
	 */
	public AddTranslatorCommandTest( ) {
		super();
	}

    @Test
    public void testAdd1() throws Exception {
        setup(ADD_TRANSLATOR_COMMAND_1, AddTranslatorCommand.class);
