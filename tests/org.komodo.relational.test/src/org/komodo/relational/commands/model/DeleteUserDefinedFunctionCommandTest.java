...
public class DeleteUserDefinedFunctionCommandTest extends AbstractCommandTest {
	...
	private static final String DELETE_USERDEFINED_FUNCTION_COMMAND_1 = "deleteUserDefinedFunctionCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testDelete1() throws Exception {
        setup(DELETE_USERDEFINED_FUNCTION_COMMAND_1, DeleteUserDefinedFunctionCommand.class);
