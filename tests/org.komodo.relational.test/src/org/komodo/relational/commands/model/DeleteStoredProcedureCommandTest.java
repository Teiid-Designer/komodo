...
public class DeleteStoredProcedureCommandTest extends AbstractCommandTest {
	...
	private static final String DELETE_STORED_PROCEDURE_COMMAND_1 = "deleteStoredProcedureCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testDelete1() throws Exception {
        setup(DELETE_STORED_PROCEDURE_COMMAND_1, DeleteStoredProcedureCommand.class);
