...
public class DeleteSourceCommandTest extends AbstractCommandTest {
	...
	private static final String DELETE_SOURCE_COMMAND_1 = "deleteSourceCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for DeleteSourceCommand
	 */
    ...
    public void testDelete1() throws Exception {
        setup(DELETE_SOURCE_COMMAND_1, DeleteSourceCommand.class);
