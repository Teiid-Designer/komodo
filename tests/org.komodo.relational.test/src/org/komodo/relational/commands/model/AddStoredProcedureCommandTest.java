...
public class AddStoredProcedureCommandTest extends AbstractCommandTest {
	...
	private static final String ADD_STORED_PROCEDURE_COMMAND_1 = "addStoredProcedureCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for AddStoredProcedureCommand
	 */
	public AddStoredProcedureCommandTest( ) {
		super();
	}

    @Test
    public void testAdd1() throws Exception {
        setup(ADD_STORED_PROCEDURE_COMMAND_1, AddStoredProcedureCommand.class);
