...
public class AddSourceCommandTest extends AbstractCommandTest {
	...
	private static final String ADD_SOURCE_COMMAND_1 = "addSourceCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for AddSourceCommand
	 */
	public AddSourceCommandTest( ) {
		super();
	}

    @Test
    public void testAdd1() throws Exception {
        setup(ADD_SOURCE_COMMAND_1, AddSourceCommand.class);
