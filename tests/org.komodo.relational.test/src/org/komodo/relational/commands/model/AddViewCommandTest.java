...
public class AddViewCommandTest extends AbstractCommandTest {
	...
	private static final String ADD_VIEW_COMMAND_1 = "addViewCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for AddViewCommand
	 */
	public AddViewCommandTest( ) {
		super();
	}

    @Test
    public void testAdd1() throws Exception {
        setup(ADD_VIEW_COMMAND_1, AddViewCommand.class);
