...
public class UnsetParameterPropertyCommandTest extends AbstractCommandTest {
    ...
    public void testUnsetProperty1() throws Exception {
        ...
        writer.write("unset-property datatypeLength" + NEW_LINE);  //$NON-NLS-1$
        writer.close();

        setup(cmdFile.getAbsolutePath(), UnsetParameterPropertyCommand.class);
        ...
        assertEquals(0, params[0].getLength(uow));
    }
