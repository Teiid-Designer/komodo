...
public class SetParameterPropertyCommandTest extends AbstractCommandTest {
    ...
    /**
	 * Test for SetParameterPropertyCommand
	 */
	public SetParameterPropertyCommandTest( ) {
		super();
	}
    ...
    public void testSetProperty1() throws Exception {
        ...
        writer.write("add-parameter myParameter" + NEW_LINE);  //$NON-NLS-1$
        writer.write("cd myParameter" + NEW_LINE);  //$NON-NLS-1$
        writer.write("set-property datatypeLength 99" + NEW_LINE);  //$NON-NLS-1$
        writer.close();

        setup(cmdFile.getAbsolutePath(), SetParameterPropertyCommand.class);
        ...
        Parameter[] params = functions[0].getParameters(uow);
        assertEquals(1, params.length);
        assertEquals("myParameter", params[0].getName(uow)); //$NON-NLS-1$
        
        assertEquals(99, params[0].getLength(uow));
    }
