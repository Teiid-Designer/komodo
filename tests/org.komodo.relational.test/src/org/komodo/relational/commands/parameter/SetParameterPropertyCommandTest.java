...
public class SetParameterPropertyCommandTest extends AbstractCommandTest {
	...
	private static final String SET_PARAMETER_PROPERTY_COMMAND_1 = "setParameterPropertyCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testSetProperty1() throws Exception {
        setup(SET_PARAMETER_PROPERTY_COMMAND_1, SetParameterPropertyCommand.class);
