...
public class SetViewPropertyCommandTest extends AbstractCommandTest {
	...
	private static final String SET_VIEW_PROPERTY_COMMAND_1 = "setViewPropertyCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for SetViewPropertyCommand
	 */
	public SetViewPropertyCommandTest( ) {
		super();
	}

    @Test
    public void testSetProperty1() throws Exception {
        setup(SET_VIEW_PROPERTY_COMMAND_1, SetViewPropertyCommand.class);
