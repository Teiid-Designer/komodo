...
public class SetMaskPropertyCommandTest extends AbstractCommandTest {
	...
	private static final String SET_MASK_PROPERTY_COMMAND_1 = "setMaskPropertyCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for SetMaskPropertyCommand
	 */
	public SetMaskPropertyCommandTest( ) {
		super();
	}

    @Test
    public void testSetProperty1() throws Exception {
        setup(SET_MASK_PROPERTY_COMMAND_1, SetMaskPropertyCommand.class);
