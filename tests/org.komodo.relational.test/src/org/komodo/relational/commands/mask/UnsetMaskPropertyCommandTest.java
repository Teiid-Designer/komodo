...
public class UnsetMaskPropertyCommandTest extends AbstractCommandTest {
	...
	private static final String UNSET_MASK_PROPERTY_COMMAND_1 = "unsetMaskPropertyCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testUnsetProperty1() throws Exception {
        setup(UNSET_MASK_PROPERTY_COMMAND_1, UnsetMaskPropertyCommand.class);
