...
public class UnsetVdbImportPropertyCommandTest extends AbstractCommandTest {
	...
	private static final String UNSET_VDB_IMPORT_PROPERTY_COMMAND_1 = "unsetVdbImportPropertyCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for UnsetVdbImportPropertyCommand
	 */
	public UnsetVdbImportPropertyCommandTest( ) {
		super();
	}

    @Test
    public void testUnsetProperty1() throws Exception {
        setup(UNSET_VDB_IMPORT_PROPERTY_COMMAND_1, UnsetVdbImportPropertyCommand.class);
