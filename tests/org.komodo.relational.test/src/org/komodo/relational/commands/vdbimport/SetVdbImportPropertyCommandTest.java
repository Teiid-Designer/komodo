...
public class SetVdbImportPropertyCommandTest extends AbstractCommandTest {
	...
	private static final String SET_VDB_IMPORT_PROPERTY_COMMAND_1 = "setVdbImportPropertyCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for SetVdbImportPropertyCommand
	 */
	public SetVdbImportPropertyCommandTest( ) {
		super();
	}

    @Test
    public void testSetProperty1() throws Exception {
        setup(SET_VDB_IMPORT_PROPERTY_COMMAND_1, SetVdbImportPropertyCommand.class);
