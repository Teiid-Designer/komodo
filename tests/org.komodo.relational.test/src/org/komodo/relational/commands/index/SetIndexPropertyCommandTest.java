...
public class SetIndexPropertyCommandTest extends AbstractCommandTest {
	...
	private static final String SET_INDEX_PROPERTY_COMMAND_1 = "setIndexPropertyCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testSetProperty1() throws Exception {
        setup(SET_INDEX_PROPERTY_COMMAND_1, SetIndexPropertyCommand.class);
