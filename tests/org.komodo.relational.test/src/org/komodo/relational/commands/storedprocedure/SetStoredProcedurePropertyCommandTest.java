...
public class SetStoredProcedurePropertyCommandTest extends AbstractCommandTest {
	...
	private static final String SET_STORED_PROCEDURE_PROPERTY_COMMAND_1 = "setStoredProcedurePropertyCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testSetProperty1() throws Exception {
        setup(SET_STORED_PROCEDURE_PROPERTY_COMMAND_1, SetStoredProcedurePropertyCommand.class);
