...
public class UnsetStoredProcedurePropertyCommandTest extends AbstractCommandTest {
	...
	private static final String UNSET_STORED_PROCEDURE_PROPERTY_COMMAND_1 = "unsetStoredProcedurePropertyCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for UnsetStoredProcedurePropertyCommand
	 */
	public UnsetStoredProcedurePropertyCommandTest( ) {
		super();
	}

    @Test
    public void testUnsetProperty1() throws Exception {
        setup(UNSET_STORED_PROCEDURE_PROPERTY_COMMAND_1, UnsetStoredProcedurePropertyCommand.class);
