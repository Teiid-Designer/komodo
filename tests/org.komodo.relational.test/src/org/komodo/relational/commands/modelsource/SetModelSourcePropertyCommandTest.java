...
public class SetModelSourcePropertyCommandTest extends AbstractCommandTest {
	...
	private static final String SET_MODEL_SOURCE_PROPERTY_COMMAND_1 = "setModelSourcePropertyCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for SetModelSourcePropertyCommand
	 */
	public SetModelSourcePropertyCommandTest( ) {
		super();
	}

    @Test
    public void testSetProperty1() throws Exception {
        setup(SET_MODEL_SOURCE_PROPERTY_COMMAND_1, SetModelSourcePropertyCommand.class);
