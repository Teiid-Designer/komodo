...
public class DeletePermissionCommandTest extends AbstractCommandTest {
    ...
    public void testSetProperty1() throws Exception {
        ...
        writer.write("add-permission myPermission1" + NEW_LINE);  //$NON-NLS-1$
        writer.write("add-permission myPermission2" + NEW_LINE);  //$NON-NLS-1$
        writer.write("delete-permission myPermission1" + NEW_LINE);  //$NON-NLS-1$
        writer.close();
        ...
        assertEquals("myPermission2", permissions[0].getName(uow)); //$NON-NLS-1$
    }
