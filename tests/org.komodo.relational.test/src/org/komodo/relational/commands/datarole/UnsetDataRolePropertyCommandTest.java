...
public class UnsetDataRolePropertyCommandTest extends AbstractCommandTest {
	...
	private static final String UNSET_DATA_ROLE_PROPERTY_COMMAND_1 = "unsetDataRolePropertyCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for UnsetDataRolePropertyCommand
	 */
	public UnsetDataRolePropertyCommandTest( ) {
		super();
	}

    @Test
    public void testUnsetProperty1() throws Exception {
    	setup(UNSET_DATA_ROLE_PROPERTY_COMMAND_1, UnsetDataRolePropertyCommand.class);
