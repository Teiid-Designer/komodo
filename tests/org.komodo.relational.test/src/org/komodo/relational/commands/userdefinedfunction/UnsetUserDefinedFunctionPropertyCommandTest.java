...
public class UnsetUserDefinedFunctionPropertyCommandTest extends AbstractCommandTest {
	...
	private static final String UNSET_USER_DEFINED_FUNCTION_PROPERTY_COMMAND_1 = "unsetUserDefinedFunctionPropertyCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for UnsetUserDefinedFunctionPropertyCommand
	 */
	public UnsetUserDefinedFunctionPropertyCommandTest( ) {
		super();
	}

    @Test
    public void testUnsetProperty1() throws Exception {
        setup(UNSET_USER_DEFINED_FUNCTION_PROPERTY_COMMAND_1, UnsetUserDefinedFunctionPropertyCommand.class);
