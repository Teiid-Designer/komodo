...
public class DeleteParameterCommandTest extends AbstractCommandTest {
	...
	private static final String DELETE_UDF_PARAMETER_COMMAND_1 = "deleteUserDefinedFunctionParameterCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testDelete1() throws Exception {
        setup(DELETE_UDF_PARAMETER_COMMAND_1, DeleteParameterCommand.class);
