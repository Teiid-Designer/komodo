...
public class SetVirtualProcedurePropertyCommandTest extends AbstractCommandTest {
	...
	private static final String SET_VIRTUAL_PROCEDURE_PROPERTY_COMMAND_1 = "setVirtualProcedurePropertyCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testSetProperty1() throws Exception {
        setup(SET_VIRTUAL_PROCEDURE_PROPERTY_COMMAND_1, SetVirtualProcedurePropertyCommand.class);
