...
public class AddParameterCommandTest extends AbstractCommandTest {
	...
	private static final String ADD_VP_PARAMETER_COMMAND_1 = "addVirtualProcedureParameterCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testAdd1() throws Exception {
        setup(ADD_VP_PARAMETER_COMMAND_1, AddParameterCommand.class);
