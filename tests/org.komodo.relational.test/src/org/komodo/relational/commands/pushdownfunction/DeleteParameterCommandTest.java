...
public class DeleteParameterCommandTest extends AbstractCommandTest {
	...
	private static final String DELETE_PF_PARAMETER_COMMAND_1 = "deletePushdownFunctionParameterCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testDelete1() throws Exception {
        setup(DELETE_PF_PARAMETER_COMMAND_1, DeleteParameterCommand.class);
