...
public class UnsetEntryPropertyCommandTest extends AbstractCommandTest {
	...
	private static final String UNSET_ENTRY_PROPERTY_COMMAND_1 = "unsetEntryPropertyCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for UnsetEntryPropertyCommand
	 */
	public UnsetEntryPropertyCommandTest( ) {
		super();
	}

    @Test
    public void testUnsetProperty1() throws Exception {
        setup(UNSET_ENTRY_PROPERTY_COMMAND_1, UnsetEntryPropertyCommand.class);
