...
public class SetEntryPropertyCommandTest extends AbstractCommandTest {
	...
	private static final String SET_ENTRY_PROPERTY_COMMAND_1 = "setEntryPropertyCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testSetProperty1() throws Exception {
        setup(SET_ENTRY_PROPERTY_COMMAND_1, SetEntryPropertyCommand.class);
