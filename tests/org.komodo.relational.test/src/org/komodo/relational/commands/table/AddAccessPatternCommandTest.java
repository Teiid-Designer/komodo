...
public class AddAccessPatternCommandTest extends AbstractCommandTest {
	...
	private static final String ADD_ACCESS_PATTERN_COMMAND_1 = "addAccessPatternCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testAdd1() throws Exception {
        setup(ADD_ACCESS_PATTERN_COMMAND_1, AddAccessPatternCommand.class);
