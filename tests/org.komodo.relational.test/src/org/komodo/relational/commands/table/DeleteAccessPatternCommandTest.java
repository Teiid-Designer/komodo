...
public class DeleteAccessPatternCommandTest extends AbstractCommandTest {
	...
	private static final String DELETE_ACCESS_PATTERN_COMMAND_1 = "deleteAccessPatternCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testDelete1() throws Exception {
        setup(DELETE_ACCESS_PATTERN_COMMAND_1, DeleteAccessPatternCommand.class);
