...
public class DeleteUniqueConstraintCommandTest extends AbstractCommandTest {
	...
	private static final String DELETE_UNIQUE_CONSTRAINT_COMMAND_1 = "deleteUniqueConstraintCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for DeleteUniqueConstraintCommand
	 */
	public DeleteUniqueConstraintCommandTest( ) {
		super();
	}

    @Test
    public void testDelete1() throws Exception {
        setup(DELETE_UNIQUE_CONSTRAINT_COMMAND_1, DeleteUniqueConstraintCommand.class);
