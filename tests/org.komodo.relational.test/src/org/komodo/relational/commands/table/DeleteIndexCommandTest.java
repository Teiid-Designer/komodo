...
public class DeleteIndexCommandTest extends AbstractCommandTest {
    ...
    /**
	 * Test for DeleteIndexCommand
	 */
	public DeleteIndexCommandTest( ) {
		super();
	}
    ...
    public void testDelete1() throws Exception {
        ...
        writer.write("add-index myIndex1" + NEW_LINE);  //$NON-NLS-1$
        writer.write("add-index myIndex2" + NEW_LINE);  //$NON-NLS-1$
        writer.write("delete-index myIndex1" + NEW_LINE);  //$NON-NLS-1$
        writer.close();

        setup(cmdFile.getAbsolutePath(), DeleteIndexCommand.class);
        ...
        assertEquals("myIndex2", indexes[0].getName(uow)); //$NON-NLS-1$
    }
