...
public class UnsetTablePropertyCommandTest extends AbstractCommandTest {
	...
	private static final String UNSET_TABLE_PROPERTY_COMMAND_1 = "unsetTablePropertyCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for UnsetTablePropertyCommand
	 */
	public UnsetTablePropertyCommandTest( ) {
		super();
	}

    @Test
    public void testUnsetProperty1() throws Exception {
        setup(UNSET_TABLE_PROPERTY_COMMAND_1, UnsetTablePropertyCommand.class);
