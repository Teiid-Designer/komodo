...
public class DeleteForeignKeyCommandTest extends AbstractCommandTest {
	...
	private static final String DELETE_FOREIGN_KEY_COMMAND_1 = "deleteForeignKeyCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testDelete1() throws Exception {
        setup(DELETE_FOREIGN_KEY_COMMAND_1, DeleteForeignKeyCommand.class);
