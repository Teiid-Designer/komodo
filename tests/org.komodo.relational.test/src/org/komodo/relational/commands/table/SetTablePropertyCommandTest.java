...
public class SetTablePropertyCommandTest extends AbstractCommandTest {
	...
	private static final String SET_TABLE_PROPERTY_COMMAND_1 = "setTablePropertyCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testSetProperty1() throws Exception {
        setup(SET_TABLE_PROPERTY_COMMAND_1, SetTablePropertyCommand.class);
