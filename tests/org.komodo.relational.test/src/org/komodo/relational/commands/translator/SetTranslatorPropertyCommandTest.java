...
public class SetTranslatorPropertyCommandTest extends AbstractCommandTest {
	...
	private static final String SET_TRANSLATOR_PROPERTY_COMMAND_1 = "setTranslatorPropertyCommand_1.txt"; //$NON-NLS-1$

    /**
	 * Test for SetTranslatorPropertyCommand
	 */
	public SetTranslatorPropertyCommandTest( ) {
		super();
	}

    @Test
    public void testSetProperty1() throws Exception {
        setup(SET_TRANSLATOR_PROPERTY_COMMAND_1, SetTranslatorPropertyCommand.class);
