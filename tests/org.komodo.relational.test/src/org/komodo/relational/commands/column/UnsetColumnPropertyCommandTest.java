...
public class UnsetColumnPropertyCommandTest extends AbstractCommandTest {
	...
	private static final String UNSET_COLUMN_PROPERTY_COMMAND_1 = "unsetColumnPropertyCommand_1.txt"; //$NON-NLS-1$
    ...
    public void testUnsetProperty1() throws Exception {
    	setup(UNSET_COLUMN_PROPERTY_COMMAND_1, UnsetColumnPropertyCommand.class);
