...
public class SmartTestKomodoSuite extends TestSuite {
    ...
    public SmartTestKomodoSuite( String projectName,
        ...
        String testDataPath = projectPath + '/' + SmartTestKomodoSuite.DEFAULT_TESTDATA_PATH;
        File testDataPathFile = new File(testDataPath);
        if (!testDataPathFile.exists()) {
            testDataPath = getUserDefinedProjectPath(projectName) + '/' + SmartTestKomodoSuite.DEFAULT_TESTDATA_PATH;
        }
    ...
    public SmartTestKomodoSuite( String testdataPath,
    ...
    public void addTestSuite( Class testClass ) {
        addTest(new SmartTestKomodoSuite(testdataPath, testClass));
    }
