...
public class DatasourceImporter extends AbstractImporter {
    ...
    protected void executeImport( UnitOfWork transaction,
        ...
        try {
            ...
            final boolean hasConnection = getWorkspaceManager().hasChild( transaction,
                                                                          connection.getName(),
            ...
            if ( shouldSequence ) {
                ...
                final Datasource ds = getWorkspaceManager().createDatasource( transaction, null, connection.getName() );
    ...
    private WorkspaceManager getWorkspaceManager() throws KException {
