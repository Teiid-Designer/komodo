...
//                return;
            ...
            fileNode.setProperty( transaction, JcrConstants.JCR_DATA, srcStream );
        } catch (Exception ex) {
            throw new KException(ex);
//        } finally {
//            try {
...
//    }
    ...
    private void deployVdb( final UnitOfWork uow,
        ...
        //        if ( vdbErrors.isEmpty() ) status.addProgressMessage( "Vdb " + vdbName + " deployed and is valid" );
        //        else status.addProgressMessage( "Vdb " + vdbName + " deployed but has validity errors" );
        //
...
//            Map<String, Datasource> dataSrcIndex = index(transaction, dataservice.getConnections(transaction));
