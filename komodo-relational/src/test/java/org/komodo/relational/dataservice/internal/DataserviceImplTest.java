...
public final class DataserviceImplTest extends RelationalModelTest {
    ...
    public void init() throws Exception {
        ...
        this.mgr = WorkspaceManager.getInstance( _repo );
...
//        InputStream usDataSrcStream = TestUtilities.getResourceAsStream(getClass(), "connection", "mysql-usstates-connection.xml");
...
//    }
    ...
    public void shouldRoundTripDataService() throws Exception {
        ...
        //        Arrays.stream( theDataService.getChildren( getTransaction() ) )
        //              .forEach( kobj -> System.out.println( kobj.getAbsolutePath() ) );
