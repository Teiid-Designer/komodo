 ...
 * 02110-1301 USA.
 */
package org.komodo.eclipse.teiid84.client.util;
...
public class AdminUtil {
	...
	public static boolean createDataSource(Admin admin, String deploymentName, String templateName, Properties properties) throws AdminException {
	...
	public static boolean waitForVDBLoad(Admin admin, String vdbName, int vdbVersion,
