...
public class SubquerySetCriteria extends AbstractSetCriteria
    implements SubqueryContainer<QueryCommand>, ISubquerySetCriteria<Expression, SQLanguageVisitorImpl, QueryCommand>{

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public SubquerySetCriteria(TeiidSeqParser p, int id) {
        super(p, id);
