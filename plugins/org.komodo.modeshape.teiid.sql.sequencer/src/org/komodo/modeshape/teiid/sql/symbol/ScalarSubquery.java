 ...
 *
 */
public class ScalarSubquery extends ASTNode implements Expression, SubqueryContainer<QueryCommand>, IScalarSubquery<SQLanguageVisitorImpl, QueryCommand> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public ScalarSubquery(TeiidSeqParser p, int id) {
        super(p, id);
    }
    ...
    public ScalarSubquery clone() {
        ScalarSubquery clone = new ScalarSubquery(this.getTeiidParser(), this.getId());
