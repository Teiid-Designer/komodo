 ...
 *
 */
public class AssignmentStatement extends Statement implements ExpressionStatement, IAssignmentStatement<Expression, SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public AssignmentStatement(TeiidSeqParser p, int id) {
        super(p, id);
