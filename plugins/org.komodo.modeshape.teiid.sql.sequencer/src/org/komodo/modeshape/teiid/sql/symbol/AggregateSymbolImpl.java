 ...
 *
 */
public class AggregateSymbolImpl extends FunctionImpl implements AggregateSymbol<SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public AggregateSymbolImpl(TeiidSeqParser p, int id) {
        super(p, id);
    }

    private void calculateType() {
        AggregateSymbol.Type aggregateFunction = getAggregateFunction();
    ...
    public void setAggregateFunction(String name) {
        AggregateSymbol.Type funcType = AggregateSymbol.Type.findAggregateFunction(name);
        if (funcType == null)
    ...
    public OrderByImpl getOrderBy() {
        return getChildforIdentifierAndRefType(TeiidSqlLexicon.AggregateSymbol.ORDER_BY_REF_NAME, OrderByImpl.class);
    }
    ...
    public CriteriaImpl getCondition() {
        return getChildforIdentifierAndRefType(TeiidSqlLexicon.AggregateSymbol.CONDITION_REF_NAME, CriteriaImpl.class);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        AggregateSymbolImpl other = (AggregateSymbolImpl)obj;
    ...
    public AggregateSymbolImpl clone() {
        AggregateSymbolImpl clone = new AggregateSymbolImpl(this.getTeiidParser(), this.getId());
