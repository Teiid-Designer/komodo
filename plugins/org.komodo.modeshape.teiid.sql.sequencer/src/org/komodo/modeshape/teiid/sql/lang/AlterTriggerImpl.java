 ...
 *
 */
public class AlterTriggerImpl extends AlterImpl<TriggerActionImpl> implements AlterTrigger<BaseExpression, SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public AlterTriggerImpl(TeiidSeqParser p, int id) {
        super(p, id);
    ...
    public AlterTriggerImpl clone() {
        AlterTriggerImpl clone = new AlterTriggerImpl(this.getTeiidParser(), this.getId());
