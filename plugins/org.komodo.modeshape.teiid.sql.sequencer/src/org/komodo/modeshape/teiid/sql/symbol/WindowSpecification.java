 ...
 *
 */
public class WindowSpecification extends ASTNode implements IWindowSpecification<SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public WindowSpecification(TeiidSeqParser p, int id) {
        super(p, id);
    }
