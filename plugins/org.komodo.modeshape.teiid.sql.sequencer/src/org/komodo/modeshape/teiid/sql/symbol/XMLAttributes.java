 ...
 *
 */
public class XMLAttributes extends ASTNode implements IXMLAttributes<SQLanguageVisitorImpl> {

    /**
     * @param p teiid parser
     * @param id node type id
     */
    public XMLAttributes(TeiidSeqParser p, int id) {
        super(p, id);
    }
    ...
    public XMLAttributes clone() {
        XMLAttributes clone = new XMLAttributes(this.getTeiidParser(), this.getId());
