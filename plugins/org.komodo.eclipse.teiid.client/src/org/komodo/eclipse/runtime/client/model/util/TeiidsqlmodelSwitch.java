 ...
 */
package org.komodo.eclipse.runtime.client.model.util;
...
import org.komodo.eclipse.runtime.client.model.Document;
import org.komodo.eclipse.runtime.client.model.TeiidSchema;
import org.komodo.eclipse.runtime.client.model.TeiidsqlmodelPackage;
 ...
 * @generated
 */
public class TeiidsqlmodelSwitch {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	protected static TeiidsqlmodelPackage modelPackage;
	 ...
	 * @generated
	 */
	public TeiidsqlmodelSwitch() {
		if (modelPackage == null) {
			modelPackage = TeiidsqlmodelPackage.eINSTANCE;
		}
	}
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TeiidsqlmodelPackage.DOCUMENT: {
				Document document = (Document)theEObject;
				Object result = caseDocument(document);
				if (result == null) result = caseViewTable(document);
				if (result == null) result = caseDerivedTable(document);
				if (result == null) result = caseTable(document);
				if (result == null) result = caseSQLObject(document);
				if (result == null) result = caseENamedElement(document);
				if (result == null) result = caseEModelElement(document);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TeiidsqlmodelPackage.TEIID_SCHEMA: {
				TeiidSchema teiidSchema = (TeiidSchema)theEObject;
				Object result = caseTeiidSchema(teiidSchema);
				if (result == null) result = caseSchema(teiidSchema);
				if (result == null) result = caseSQLObject(teiidSchema);
				if (result == null) result = caseENamedElement(teiidSchema);
				if (result == null) result = caseEModelElement(teiidSchema);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Teiid Schema</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Teiid Schema</em>'.
