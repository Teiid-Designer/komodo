 ...
 */
package org.komodo.eclipse.runtime.client.driver;
...
import org.komodo.eclipse.runtime.client.Messages;
...
public class TeiidDriverUIContributor implements IDriverUIContributor, Listener {
    ...
    /**
     * @return the contributorInformation
     */
    public IDriverUIContributorInformation getContributorInformation() {
        return this.contributorInformation;
    }
