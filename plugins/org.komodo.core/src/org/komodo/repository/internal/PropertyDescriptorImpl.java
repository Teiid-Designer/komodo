 ...
 */
class PropertyDescriptorImpl implements PropertyDescriptor {

    /**
     * @param type
     *        the {@link PropertyType JCR property type} being converted
     * @return the object property type or {@link Type#UNDEFINED} if type cannot be determined
     */
    ...
    /**
     * @param type
     *        the {@link KomodoObject Komodo object} {@link Property property} {@link PropertyDescriptor.Type type} being converted
    ...
    PropertyDescriptorImpl( final PropertyDefinition propDefn ) throws KException {
