...
public class KEngine {
    ...
    private static KEngine instance;
    ...
    private void initRepository() {
        ...
        Iterator<IRepository> loaderIter = loader.iterator();
        if (loaderIter.hasNext()) {
            repository = loaderIter.next();
        } else {
            throw new RuntimeException(Messages.getString(Messages.KEngine.No_Available_Repositories));
        }
    }
