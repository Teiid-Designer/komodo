...
public class CoreArgCheck {
    ...
    public static final void isNonNegative( int value,
                                            String message ) {
        if (value < 0) {
            final String msg = message != null ? message : Messages.getString(CORE.CoreArgCheck_isNonNegativeInt); 
    ...
    public static final void isPositive( int value,
                                         String message ) {
        if (value <= 0) {
            final String msg = message != null ? message : Messages.getString(CORE.CoreArgCheck_isPositiveInt);
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static final void isNotZeroLength( String value,
        ...
        isNotNull(value);
        if (value.length() <= 0) {
            final String msg = message != null ? message : Messages.getString(CORE.CoreArgCheck_isStringNonZeroLength);
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static final void isNotNull( Object value,
                                        String message ) {
        if (value == null) {
            final String msg = message != null ? message : Messages.getString(CORE.CoreArgCheck_isNonNull);
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static final void isInstanceOf( Class theClass,
        ...
        if (!theClass.isInstance(value)) {
            final String msg = message != null ? message : Messages.getString(CORE.CoreArgCheck_isInstanceOf, theClass.getName(), value.getClass().getName()); //$NON-NLS-1$
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static final void isNotEmpty( Collection collection,
        ...
        if (collection.isEmpty()) {
            final String msg = message != null ? message : Messages.getString(CORE.CoreArgCheck_isCollectionNotEmpty); 
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static final void isNotEmpty( Properties properties,
        ...
        if (properties.isEmpty()) {
            final String msg = message != null ? message : Messages.getString(CORE.CoreArgCheck_isPropertiesNotEmpty);
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static final void contains( Collection collection,
        ...
        if (!collection.contains(value)) {
            final String msg = message != null ? message : Messages.getString(CORE.CoreArgCheck_contains);
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static final void isEqual( boolean value1,
                                      ...
                                      String message ) {
        if (value1 != value2) {
            final String msg = message != null ? message : Messages.getString(CORE.Assertion_isEqual, new Object[] {new Boolean(value1), new Boolean(value2)}); //$NON-NLS-1$
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static final void isNotEqual( boolean value1,
                                         ...
                                         String message ) {
        if (value1 == value2) {
            final String msg = message != null ? message : Messages.getString(CORE.Assertion_isNotEqual, new Object[] {new Boolean(value1), new Boolean(value2)}); //$NON-NLS-1$
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static final void isEqual( int value1,
                                      ...
                                      String message ) {
        if (value1 != value2) {
            final String msg = message != null ? message : Messages.getString(CORE.Assertion_isEqual, new Object[] {new Integer(value1), new Integer(value2)}); //$NON-NLS-1$
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static final void isNotEqual( int value1,
                                         ...
                                         String message ) {
        if (value1 == value2) {
            final String msg = message != null ? message : Messages.getString(CORE.Assertion_isNotEqual, new Object[] {new Integer(value1), new Integer(value2)}); //$NON-NLS-1$
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static final void isEqual( Object object1,
        ...
        if (object1 == null) {
            if (object2 != null) {
                final String msg = message != null ? message : Messages.getString(CORE.Assertion_isEqual, new Object[] {object1, object2});
                throw new IllegalArgumentException(msg);
            }
            // else both are null
        } else {
