...
public interface KomodoLexicon extends StringConstants {
     ...
     */
    public interface DataSource extends LibraryComponent {
    ...
    /**
     * The JCR names associated with the data sources grouping node type.
     */
    public interface DataSources {
         ...
         * The node type name of a data source. Value is {@value}.
         */
        String DATA_SOURCE = DataSource.NODE_TYPE;
    ...
    public interface Library {
         ...
         */
        String DATA_SOURCES = DataSources.GROUP_NODE;
    ...
    public interface LibraryComponent {
        ...
        /**
         * The name and node type name of the library component mixin. Value is {@value}.
         */
     ...
     */
    public interface Schema extends LibraryComponent {
        ...
        /**
         * The name of the path property. Value is {@value}.
         */
     ...
     */
    public interface Vdb extends LibraryComponent {
