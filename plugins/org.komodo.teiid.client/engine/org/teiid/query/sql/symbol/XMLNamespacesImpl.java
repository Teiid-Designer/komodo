 ...
 *
 */
public class XMLNamespacesImpl extends SimpleNode implements XMLNamespaces<TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public XMLNamespacesImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public XMLNamespacesImpl clone() {
        XMLNamespacesImpl clone = new XMLNamespacesImpl(this.parser, this.id);
