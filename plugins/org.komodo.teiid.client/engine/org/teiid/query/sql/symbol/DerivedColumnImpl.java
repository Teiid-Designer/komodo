 ...
 *
 */
public class DerivedColumnImpl extends SimpleNode implements DerivedColumn<TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public DerivedColumnImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public DerivedColumnImpl clone() {
        DerivedColumnImpl clone = new DerivedColumnImpl(this.parser, this.id);
