 ...
 *
 */
public class XMLQueryImpl extends SimpleNode implements BaseExpression, XMLQuery<TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public XMLQueryImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public XMLQueryImpl clone() {
        XMLQueryImpl clone = new XMLQueryImpl(this.parser, this.id);
