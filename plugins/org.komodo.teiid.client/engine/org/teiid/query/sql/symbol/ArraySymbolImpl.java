 ...
 *
 */
public class ArraySymbolImpl extends SimpleNode implements BaseExpression, Array<TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public ArraySymbolImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public ArraySymbolImpl clone() {
        ArraySymbolImpl clone = new ArraySymbolImpl(this.parser, this.id);
