 ...
 *
 */
public class ReferenceImpl extends SimpleNode implements BaseExpression, Reference<TCLanguageVisitorImpl> {
    ...
    private ElementSymbolImpl expression;
     ...
     * @param id
     */
    public ReferenceImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
     ...
     */
    public void setExpression(ElementSymbolImpl expression) {
    ...
    public ReferenceImpl clone() {
        ReferenceImpl clone = new ReferenceImpl(this.parser, this.id);
