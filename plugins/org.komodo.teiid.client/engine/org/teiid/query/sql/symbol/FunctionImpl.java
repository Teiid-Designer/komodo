 ...
 *
 */
public class FunctionImpl extends SimpleNode implements BaseExpression, Function<TCFunctionDescriptor, TCLanguageVisitorImpl> {

    private Class<?> type;

    private String name;

    private BaseExpression[] args;
     ...
     * @param id
     */
    public FunctionImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public void insertConversion(int index, TCFunctionDescriptor functionDescriptor) { 
        ...
        BaseExpression newArg[] = new BaseExpression[] { args[index],  constant};
        
        // Replace old expression with new expression, using old as arg
        FunctionImpl func = getTeiidParser().createASTNode(ASTNodes.FUNCTION);
    ...
    public FunctionImpl clone() {
        FunctionImpl clone = new FunctionImpl(this.parser, this.id);
