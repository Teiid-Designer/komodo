 ...
 *
 */
public class ConstantImpl extends SimpleNode implements BaseExpression, Constant<TCLanguageVisitorImpl> {

    private Class<?> type = DefaultDataTypeManager.DefaultDataTypes.NULL.getTypeClass();

    private boolean multiValued;

    private static Map<TeiidVersion, ConstantImpl> nullCache = new HashMap<TeiidVersion, ConstantImpl>();
    
    /**
     * @param teiidParser
     * @return a null constant for the given teiid parser if one has not already been created
     */
    public static ConstantImpl getNullConstant(TeiidClientParser teiidParser) {
        ConstantImpl constant = nullCache.get(teiidParser.getVersion());
        if (constant == null) {
     ...
     * @param id
     */
    public ConstantImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public ConstantImpl clone() {
        ConstantImpl clone = new ConstantImpl(this.parser, this.id);
