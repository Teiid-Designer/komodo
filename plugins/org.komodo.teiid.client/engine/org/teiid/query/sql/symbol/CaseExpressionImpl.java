 ...
 *
 */
public class CaseExpressionImpl extends SimpleNode implements BaseExpression, CaseExpression<TCLanguageVisitorImpl> {
     ...
     */
    private List<BaseExpression> when = null;
     ...
     * @param id
     */
    public CaseExpressionImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
     ...
     */
    public List<BaseExpression> getWhen() {
        return when;
    }
     ...
     */
    public void setWhen(List<BaseExpression> when, List<BaseExpression> then) {
     ...
     * @param then
     */
    protected void setThen(List<BaseExpression> then) {
        if (this .then != then) {
    ...
    public CaseExpressionImpl clone() {
        CaseExpressionImpl clone = new CaseExpressionImpl(this.parser, this.id);
