 ...
 *
 */
public class ExistsCriteriaImpl extends CriteriaImpl
    implements PredicateCriteria, BaseSubqueryContainer<QueryCommandImpl>, ExistsCriteria<TCLanguageVisitorImpl, QueryCommandImpl> {
     ...
     * @param id
     */
    public ExistsCriteriaImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    @Override
    public void setCommand(QueryCommandImpl subqueryCommand){
    ...
    public ExistsCriteriaImpl clone() {
        ExistsCriteriaImpl clone = new ExistsCriteriaImpl(this.parser, this.id);
