 ...
 *
 */
public class SetClauseImpl extends SimpleNode implements SetClause<TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public SetClauseImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public SetClauseImpl clone() {
        SetClauseImpl clone = new SetClauseImpl(this.parser, this.id);
