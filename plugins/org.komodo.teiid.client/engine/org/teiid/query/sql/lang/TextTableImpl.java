 ...
 *
 */
public class TextTableImpl extends TableFunctionReferenceImpl implements TextTable<TCLanguageVisitorImpl> {

    private BaseExpression file;

    private List<TextColumnImpl> columns = new ArrayList<TextColumnImpl>();
     ...
     * @param id
     */
    public TextTableImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public TextTableImpl clone() {
        TextTableImpl clone = new TextTableImpl(this.parser, this.id);
