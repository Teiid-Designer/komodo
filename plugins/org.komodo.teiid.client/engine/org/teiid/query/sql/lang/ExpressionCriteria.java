 ...
 *
 */
public class ExpressionCriteria extends Criteria implements IExpressionCriteria<TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public ExpressionCriteria(TeiidClientParser p, int id) {
        super(p, id);
    }
