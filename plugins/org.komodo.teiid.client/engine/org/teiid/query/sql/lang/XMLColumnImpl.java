 ...
 *
 */
public class XMLColumnImpl extends ProjectedColumnImpl implements XMLColumn<TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public XMLColumnImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public XMLColumnImpl clone() {
        XMLColumnImpl clone = new XMLColumnImpl(this.parser, this.id);
