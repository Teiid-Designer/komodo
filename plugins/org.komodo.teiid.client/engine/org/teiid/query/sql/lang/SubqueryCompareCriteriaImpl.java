 ...
 *
 */
public class SubqueryCompareCriteriaImpl extends AbstractCompareCriteria
    implements BaseSubqueryContainer<QueryCommandImpl>, SubqueryCompareCriteria< TCLanguageVisitorImpl, QueryCommandImpl> {
     ...
     * @param id
     */
    public SubqueryCompareCriteriaImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public BaseExpression getRightExpression() {
        ScalarSubqueryImpl scalarSubquery = parser.createASTNode(ASTNodes.SCALAR_SUBQUERY);
    ...
    public SubqueryCompareCriteriaImpl clone() {
        SubqueryCompareCriteriaImpl clone = new SubqueryCompareCriteriaImpl(this.parser, this.id);
