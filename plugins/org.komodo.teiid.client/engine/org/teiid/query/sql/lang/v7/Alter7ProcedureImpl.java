 ...
 */
public class Alter7ProcedureImpl extends AlterProcedureImpl<CreateUpdateProcedureCommandImpl> {

    /**
     * @param p
     * @param id
     */
    public Alter7ProcedureImpl(Teiid7ClientParser p, int id) {
        super(p, id);
    }
    ...
    @Override
    public Alter7ProcedureImpl clone() {
        Alter7ProcedureImpl clone = new Alter7ProcedureImpl((Teiid7ClientParser) this.parser, this.id);
