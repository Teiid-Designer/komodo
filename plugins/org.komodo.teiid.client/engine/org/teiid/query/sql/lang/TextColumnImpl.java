 ...
 *
 */
public class TextColumnImpl extends ProjectedColumnImpl implements TextColumn<TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public TextColumnImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public TextColumnImpl clone() {
        TextColumnImpl clone = new TextColumnImpl(this.parser, this.id);
