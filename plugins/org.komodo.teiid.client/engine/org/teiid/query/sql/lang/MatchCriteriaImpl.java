...
public class MatchCriteriaImpl extends CriteriaImpl
    implements PredicateCriteria, MatchCriteria<BaseExpression, TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public MatchCriteriaImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public MatchCriteriaImpl clone() {
        MatchCriteriaImpl clone = new MatchCriteriaImpl(this.parser, this.id);
