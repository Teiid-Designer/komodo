 ...
 *
 */
public class StoredProcedureImpl extends ProcedureContainer
    implements BaseTargetedCommand, StoredProcedure<SPParameterImpl, BaseExpression, TCLanguageVisitorImpl> {

    /** Used as parameters */
    private Map<Integer, SPParameterImpl> mapOfParameters = new TreeMap<Integer, SPParameterImpl>();
     ...
     * @param id
     */
    public StoredProcedureImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    */
    ...
    private SPParameterImpl getResultSetParameter(){
     ...
     */
     public Collection<SPParameterImpl> getParameters(){
     ...
     */
    public SPParameterImpl getParameter(int index){
    ...
    */
    ...
    public boolean returnsResultSet(){
        SPParameterImpl param = getResultSetParameter();
     ...
     * @param group
     */
    public void setGroupSymbol(GroupSymbolImpl group){
    ...
    public List<ElementSymbolImpl> getResultSetColumns(){
        SPParameterImpl resultSetParameter = getResultSetParameter();
        if(resultSetParameter != null){
            List<ElementSymbolImpl> result = new ArrayList<ElementSymbolImpl>(resultSetParameter.getResultSetColumns().size());
            for (Iterator<ElementSymbolImpl> i = resultSetParameter.getResultSetColumns().iterator(); i.hasNext();) {
                ElementSymbolImpl symbol = i.next().clone();
    ...
    public List getProjectedSymbols(){
        ...
        List<ElementSymbolImpl> result = new ArrayList<ElementSymbolImpl>(getResultSetColumns());
        //add out/inout parameter symbols
        for (SPParameterImpl parameter : mapOfParameters.values()) {
            if(parameter.getParameterType() == ParameterInfo.RETURN_VALUE.index()){
                ElementSymbolImpl symbol = parameter.getParameterSymbol();
    ...
    public StoredProcedureImpl clone() {
        StoredProcedureImpl clone = new StoredProcedureImpl(this.parser, this.id);
