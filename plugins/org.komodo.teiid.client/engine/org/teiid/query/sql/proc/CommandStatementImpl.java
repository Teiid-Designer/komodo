 ...
 *
 */
public class CommandStatementImpl extends StatementImpl
    implements BaseSubqueryContainer<CommandImpl>, CommandStatement<TCLanguageVisitorImpl, CommandImpl> {
     ...
     * @param id
     */
    public CommandStatementImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public CommandStatementImpl clone() {
        CommandStatementImpl clone = new CommandStatementImpl(this.parser, this.id);
