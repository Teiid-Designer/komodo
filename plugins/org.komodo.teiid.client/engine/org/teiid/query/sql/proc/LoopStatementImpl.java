...
public class LoopStatementImpl extends StatementImpl
    implements Labeled, BaseSubqueryContainer<CommandImpl>, LoopStatement<TCLanguageVisitorImpl, CommandImpl> {

    private String cursorName;

    private BlockImpl loopBlock;

    private CommandImpl query;
     ...
     * @param id
     */
    public LoopStatementImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
     ...
     * @param query
     */
    public void setCommand(QueryImpl query) {
        this.query = query;
    }
    ...
    public LoopStatementImpl clone() {
        LoopStatementImpl clone = new LoopStatementImpl(this.parser, this.id);
