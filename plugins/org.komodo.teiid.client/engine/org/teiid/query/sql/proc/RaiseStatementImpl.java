...
public class RaiseStatementImpl extends StatementImpl
    implements BaseExpressionStatement, RaiseStatement<TCLanguageVisitorImpl, BaseExpression> {
     ...
     * @param id
     */
    public RaiseStatementImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public RaiseStatementImpl clone() {
        RaiseStatementImpl clone = new RaiseStatementImpl(this.parser, this.id);
