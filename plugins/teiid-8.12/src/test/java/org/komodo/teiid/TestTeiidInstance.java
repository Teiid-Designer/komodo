...
public class TestTeiidInstance {
    ...
    private static final TeiidVersion TEIID_VERSION = Version.TEIID_8_12_4.get();

    private TeiidInstanceImpl teiidInstance;
    ...
    public void setup() throws Exception {
        ...
        teiidInstance = new TeiidInstanceImpl(parent, TEIID_VERSION, jdbcInfo);
    }
    ...
    public void testVersion() throws Exception {
        ...
        assertEquals(TEIID_VERSION, version);
    }
