...
public class SqlSourceViewerConfiguration
    ...
    public IContentAssistant getContentAssistant(ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(
			new SqlCompletionProcessor(teiidVersion),
    ...
    public IPresentationReconciler getPresentationReconciler(ISourceViewer sourceViewer) {
        ...
        SqlCodeScanner scanner = new SqlCodeScanner(teiidVersion, colorManager);
    ...
    public IContentFormatter getContentFormatter(ISourceViewer sourceViewer) {
    	...
    	IFormattingStrategy keyword = new SqlWordStrategy(teiidVersion);
