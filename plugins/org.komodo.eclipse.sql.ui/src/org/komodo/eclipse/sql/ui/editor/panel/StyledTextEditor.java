 ...
 * @since 8.0
 */
public class StyledTextEditor implements IMenuListener, KeyListener {
    ...
    private IAction getAction( String id ) {
        if (id.equals(COPY_ID)) {
            ArgCheck.isTrue(isAllowCopy(), "Editor does not allow Copy"); //$NON-NLS-1$
        ...
        if (id.equals(CUT_ID)) {
            ArgCheck.isTrue(isAllowCut(), "Editor does not allow Cut"); //$NON-NLS-1$
        ...
        if (id.equals(FIND_ID)) {
            ArgCheck.isTrue(isAllowFind(), "Editor does not allow Find"); //$NON-NLS-1$
        ...
        if (id.equals(PASTE_ID)) {
            ArgCheck.isTrue(isAllowPaste(), "Editor does not allow Paste"); //$NON-NLS-1$
        ...
        if (id.equals(REDO_ID)) {
            ArgCheck.isTrue(isAllowUndoRedo(), "Editor does not allow Redo"); //$NON-NLS-1$
        ...
        if (id.equals(SELECT_ALL_ID)) {
            ArgCheck.isTrue(isAllowSelectAll(), "Editor does not allow Select All"); //$NON-NLS-1$
    ...
    private class ContextMenuAction extends Action {
        ...
        public ContextMenuAction( String id ) {
            ...
            if (this.id.equals(UNDO_ID)) {
                ...
                tempAction.setText("find"); //$NON-NLS-1$ //TODO
//TODO
