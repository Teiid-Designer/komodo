...
/**
 * A {@link ShellCommand command} that changes the context to the Komodo library area.
 * <p>
 * Usage:
 * <p>
 * <code>&nbsp;&nbsp;
...
public class LibraryCommand extends BuiltInShellCommand {
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( ShellI18n.libraryHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( ShellI18n.libraryExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( ShellI18n.libraryUsage ) );
    }
