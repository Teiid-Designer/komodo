...
public final class DeleteParameterCommand extends PushdownFunctionShellCommand {
    ...
    protected CommandResult doExecute() {
        ...
        try {
            ...
            result = new CommandResultImpl( I18n.bind( PushdownFunctionCommandsI18n.parameterDeleted, paramName ) );
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( PushdownFunctionCommandsI18n.deleteParameterHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( PushdownFunctionCommandsI18n.deleteParameterExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( PushdownFunctionCommandsI18n.deleteParameterUsage ) );
    }
