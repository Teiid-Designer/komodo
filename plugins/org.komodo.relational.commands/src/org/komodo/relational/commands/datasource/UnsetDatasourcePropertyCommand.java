...
/**
 * A shell command to unset {@link Datasource datasource} properties.
 */
public final class UnsetDatasourcePropertyCommand extends DatasourceShellCommand {
     ...
     */
    public UnsetDatasourcePropertyCommand( final WorkspaceStatus status ) {
        super( NAME, status );
    }
    ...
    protected void printHelpDescription( final int indent ) {
        print( indent, I18n.bind( DatasourceCommandsI18n.unsetDatasourcePropertyHelp, getName() ) );
    }
    ...
    protected void printHelpExamples( final int indent ) {
        print( indent, I18n.bind( DatasourceCommandsI18n.unsetDatasourcePropertyExamples ) );
    }
    ...
    protected void printHelpUsage( final int indent ) {
        print( indent, I18n.bind( DatasourceCommandsI18n.unsetDatasourcePropertyUsage ) );
    }
