...
import static org.komodo.relational.commands.foreignkey.ForeignKeyCommandMessages.DeleteColumnCommand.COLUMN_DELETED;
import static org.komodo.relational.commands.foreignkey.ForeignKeyCommandMessages.General.MISSING_COLUMN_NAME;
...
/**
 * A shell command to delete a Column from a ForeignKey.
 */
public final class DeleteColumnCommand extends ForeignKeyShellCommand {
    ...
    protected boolean doExecute() throws Exception {
        ...
        fk.removeColumn( getTransaction(), columnName );
    ...
    public int tabCompletion( final String lastArgument,
        ...
        final ForeignKey fk = getForeignKey();
        final Column[] columns = fk.getColumns( uow );
