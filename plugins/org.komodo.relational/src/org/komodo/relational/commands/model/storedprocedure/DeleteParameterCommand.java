...
import static org.komodo.relational.commands.model.storedprocedure.StoredProcedureCommandMessages.DeleteParameterCommand.PARAMETER_DELETED;
...
public final class DeleteParameterCommand extends StoredProcedureShellCommand {
    ...
    static final String NAME = "delete-sp-parameter"; //$NON-NLS-1$
