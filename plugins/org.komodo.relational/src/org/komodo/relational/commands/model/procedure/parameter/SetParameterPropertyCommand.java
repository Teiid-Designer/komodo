 ...
 */
package org.komodo.relational.commands.model.procedure.parameter;
...
import static org.komodo.relational.commands.model.procedure.parameter.ParameterCommandMessages.General.INVALID_NULLABLE_PROPERTY_VALUE;
import static org.komodo.relational.commands.model.procedure.parameter.ParameterCommandMessages.General.INVALID_DIRECTION_PROPERTY_VALUE;
...
public final class SetParameterPropertyCommand extends ParameterShellCommand {
    ...
    private static final List< String > ALL_PROPS = Arrays.asList( new String[] { DATATYPE_NAME, DEFAULT_VALUE, DIRECTION,
                                                                                  LENGTH, NULLABLE, PRECISION, PRIMARY_TYPE,
                                                                                  RESULT, SCALE } );
