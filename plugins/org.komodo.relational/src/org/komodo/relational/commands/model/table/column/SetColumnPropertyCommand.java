...
import static org.komodo.relational.commands.model.table.column.ColumnCommandMessages.General.INVALID_NULLABLE_PROPERTY_VALUE;
import static org.komodo.relational.commands.model.table.column.ColumnCommandMessages.General.INVALID_SEARCHABLE_PROPERTY_VALUE;
...
public final class SetColumnPropertyCommand extends ColumnShellCommand {
    ...
    private static final List< String > ALL_PROPS = Arrays.asList( new String[] { AUTO_INCREMENTED, CASE_SENSITIVE, CHAR_OCTET_LENGTH, COLLATION_NAME,
                                                                                  ...
                                                                                  NULLABLE, NULL_VALUE_COUNT, PRECISION, PRIMARY_TYPE,
    ...
    protected boolean doExecute() throws Exception {
        ...
        switch ( name ) {
            ...
            case PRECISION:
                ...
                break;
            case PRIMARY_TYPE:
                column.setPrimaryType(transaction, value);
                break;
            case RADIX:
                try {
