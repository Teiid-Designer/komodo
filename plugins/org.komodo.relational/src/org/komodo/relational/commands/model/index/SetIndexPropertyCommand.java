...
public final class SetIndexPropertyCommand extends IndexShellCommand {
    ...
    static final String NAME = "set-index-property"; //$NON-NLS-1$
    ...
    private static final List< String > ALL_PROPS = Arrays.asList( new String[] { PRIMARY_TYPE, EXPRESSION } );
    ...
    protected boolean doExecute() throws Exception {
        ...
        switch ( name ) {
            case PRIMARY_TYPE:
                index.setPrimaryType(transaction, value);
                break;
            case EXPRESSION:
