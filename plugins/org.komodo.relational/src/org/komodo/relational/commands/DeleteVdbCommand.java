...
public final class DeleteVdbCommand extends WorkspaceShellCommand {
    ...
    protected CommandResult doExecute() {
        ...
        try {
            ...
            final KomodoObject[] vdbs = mgr.getChildrenOfType(getTransaction(), VdbLexicon.Vdb.VIRTUAL_DATABASE);
            ...
            if(objToDelete[0]==null) {
                result = new CommandResultImpl( false, getMessage( VDB_NOT_FOUND ), null );
            } else {
    ...
    public int tabCompletion( final String lastArgument,
        ...
        final WorkspaceManager mgr = getWorkspaceManager();
        final KomodoObject[] vdbs = mgr.getChildrenOfType(uow, VdbLexicon.Vdb.VIRTUAL_DATABASE);
