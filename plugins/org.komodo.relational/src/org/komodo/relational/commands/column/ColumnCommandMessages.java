 ...
 */
public class ColumnCommandMessages implements StringConstants {

    private static final String BUNDLE_NAME = ( ColumnCommandMessages.class.getPackage().getName() + DOT + ColumnCommandMessages.class.getSimpleName().toLowerCase() );
