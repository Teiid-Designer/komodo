 ...
 */
public final class SetAccessPatternPropertyCommand extends AccessPatternShellCommand {

    static final String NAME = "set-access-pattern-property"; //$NON-NLS-1$
     ...
     */
    public SetAccessPatternPropertyCommand( final WorkspaceStatus status ) {
    ...
    protected boolean doExecute() throws Exception {
        ...
        switch ( name ) {
            case PRIMARY_TYPE:
                ap.setPrimaryType(transaction, value);
                break;
            default:
                success = false;
