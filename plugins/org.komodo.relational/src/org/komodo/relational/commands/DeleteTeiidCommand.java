...
public final class DeleteTeiidCommand extends WorkspaceShellCommand {
    ...
    protected CommandResult doExecute() {
        ...
        try {
            ...
            final KomodoObject[] teiids = mgr.getChildrenOfType(getTransaction(), KomodoLexicon.Teiid.NODE_TYPE);
            ...
            if(objToDelete[0]==null) {
                result = new CommandResultImpl( false, getMessage( TEIID_NOT_FOUND ), null );
            } else {
    ...
    public int tabCompletion( final String lastArgument,
        ...
        final WorkspaceManager mgr = getWorkspaceManager();
        final KomodoObject[] teiids = mgr.getChildrenOfType(uow, KomodoLexicon.Teiid.NODE_TYPE);
