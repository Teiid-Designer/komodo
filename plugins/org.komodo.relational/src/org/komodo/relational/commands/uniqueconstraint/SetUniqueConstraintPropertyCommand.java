...
/**
 * A shell command to set UniqueConstraint properties
 */
public final class SetUniqueConstraintPropertyCommand extends UniqueConstraintShellCommand {

    static final String NAME = "set-unique-constraint-property"; //$NON-NLS-1$
     ...
     */
    public SetUniqueConstraintPropertyCommand( final WorkspaceStatus status ) {
    ...
    protected boolean doExecute() throws Exception {
        ...
        switch ( name ) {
            case PRIMARY_TYPE:
                uc.setPrimaryType(transaction, value);
                break;
            default:
                success = false;
