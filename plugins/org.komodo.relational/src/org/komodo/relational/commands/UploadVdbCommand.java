...
import static org.komodo.relational.commands.WorkspaceCommandMessages.UploadVdbCommand.MISSING_INPUT_VDB_FILE_PATH;
import static org.komodo.relational.commands.WorkspaceCommandMessages.UploadVdbCommand.MISSING_VDB_NAME;
import static org.komodo.relational.commands.WorkspaceCommandMessages.UploadVdbCommand.VDB_INPUT_FILE_IS_EMPTY;
import static org.komodo.relational.commands.WorkspaceCommandMessages.UploadVdbCommand.VDB_OVERWRITE_DISABLED;
import static org.komodo.relational.commands.WorkspaceCommandMessages.UploadVdbCommand.VDB_UPLOADED;
...
public final class UploadVdbCommand extends WorkspaceShellCommand {
    ...
    protected CommandResult doExecute() {
        try {
            ...
            if ( getWorkspaceManager().hasChild( uow, vdbName ) && !overwrite ) {
