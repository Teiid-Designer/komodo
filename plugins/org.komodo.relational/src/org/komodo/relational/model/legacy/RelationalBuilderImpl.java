...
public class RelationalBuilderImpl implements RelationalBuilder {
	...
	/* (non-Javadoc)
	 * @see org.komodo.relational.core.RelationalBuilder#create(int, java.lang.String, org.komodo.relational.model.legacy.RelationalObject)
	 */
	@Override
	public RelationalObject create(int objectType, String name,
	...
	/* (non-Javadoc)
	 * @see org.komodo.relational.core.RelationalBuilder#getProperties(org.komodo.relational.model.legacy.RelationalObject)
	 */
	@Override
