...
abstract class TableConstraintImpl extends RelationalObjectImpl implements TableConstraint {
    ...
    protected TableConstraintImpl( final Repository repository,
    ...
    public void addColumn( final UnitOfWork uow,
        ...
        try {
            ...
            final String columnId = columnToAdd.getProperty(transaction, JcrLexicon.UUID.getString()).getStringValue();
    ...
    public Table getTable( final UnitOfWork uow ) throws KException {
        ...
        try {
            ...
            if (parent.hasDescriptor(transaction, CreateTable.TABLE_STATEMENT)) {
                result = new TableImpl(getRepository(), parent.getAbsolutePath());
            } else if (parent.hasDescriptor(transaction, CreateTable.VIEW_STATEMENT)) {
                result = new ViewImpl(getRepository(), parent.getAbsolutePath());
            } else {
    ...
    public void removeColumn( final UnitOfWork uow,
        ...
        try {
            final String columnId = columnToRemove.getProperty(transaction, JcrLexicon.UUID.getString()).getStringValue();
