 ...
 *
 */
public interface CompoundCriteria<C extends Criteria, LV extends LanguageVisitor> 
    extends LogicalCriteria<LV> {
    ...
    /**
     * Get the number of {@link Criteria}
     * 
    ...
    /**
     * Get the {@link Criteria} at given index
     * 
     * @param index
     * 
     * @return criteria
