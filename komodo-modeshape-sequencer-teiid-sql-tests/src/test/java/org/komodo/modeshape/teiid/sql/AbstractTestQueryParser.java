...
public abstract class AbstractTestQueryParser extends AbstractTest<CommandImpl> implements StringConstants {
    ...
    protected void helpTest(String sql, String expectedString, CommandImpl expectedCommand, ParseInfo info) {
        ...
        try {
            ...
            if (e instanceof TeiidClientException) {
                ((TeiidClientException)e).getParseThrowable().printStackTrace();
            }
            fail(e.getMessage());
        }
...
//        assertEquals("SQL strings do not match: ", expectedString, actualString);
 ...
 // ======================== Joins ===============================================
    ...
    public void testCompoundHaving() {
        ...
        CompoundCriteriaImpl having = getFactory().newCompoundCriteria(CompoundCriteria.AND,
    ...
    public void testFunctionOfAggregates() {
        ...
        SelectImpl select = getFactory().newSelect();
        AggregateSymbolImpl agg1 = getFactory().newAggregateSymbol("COUNT", false, getFactory().newElementSymbol("a"));
        AggregateSymbolImpl agg2 = getFactory().newAggregateSymbol("SUM", false, getFactory().newElementSymbol("a"));
    ...
    public void testBooleanLiteralTrue() {
        ...
        Class<?> expectedType = getDataTypeService().getDefaultDataClass(DataTypeName.BOOLEAN);
    ...
    public void testIsNullCriteria1() {
        ...
        CriteriaImpl crit = getFactory().newIsNullCriteria(getFactory().newObject(a));
    ...
    public void testIsNullCriteria2() {
        ...
        IsNullCriteriaImpl crit = getFactory().newIsNullCriteria(getFactory().newObject(a));
    ...
    public void testNotIsNullCriteria() {
        ...
        CriteriaImpl crit = getFactory().newNotCriteria(getFactory().newIsNullCriteria(getFactory().newObject(a)));
    ...
    public void testStringNotEqualDoubleTicks() {
        ...
        CriteriaImpl crit = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.NE, ex);
    ...
    public void testNotEquals2() {
        ...
        CriteriaImpl crit = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.NE, constant);
    ...
    public void testPartlyQuotedGroup() {
        ...
        CriteriaImpl crit = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.EQ, getFactory().newConstant(new Integer(5)));
    ...
    public void testBetween1() {
        ...
        CriteriaImpl crit = getFactory().newBetweenCriteria(getFactory().newObject(a), constant1, constant2);
    ...
    public void testBetween2() {
        ...
        BaseExpression constant1 = getFactory().newConstant(new Integer(1000));
        BaseExpression constant2 = getFactory().newConstant(new Integer(2000));
        BetweenCriteriaImpl crit = getFactory().newBetweenCriteria(getFactory().newObject(a), constant1, constant2);
        crit.setNegated(true);
        QueryImpl query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
    ...
    public void testCompareLT() {
        ...
        CriteriaImpl crit = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.LT, constant);
    ...
    public void testCompareGT() {
        ...
        BaseExpression constant = getFactory().newConstant(new Integer(1000));
        CriteriaImpl crit = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.GT, constant);
    ...
    public void testCompareLE() {
        ...
        BaseExpression constant = getFactory().newConstant(new Integer(1000));
        CriteriaImpl crit = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.LE, constant);
    ...
    public void testCompareGE() {
        ...
        BaseExpression constant = getFactory().newConstant(new Integer(1000));
        CriteriaImpl crit = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.GE, constant);
    ...
    protected void helpTestCompoundCompare(String testSQL) {
        ...
        BaseExpression constant = getFactory().newConstant(new Integer(1000));
        CriteriaImpl crit2 = getFactory().newCompareCriteria(getFactory().newObject(a), Operator.EQ, constant);
        CriteriaImpl crit = getFactory().newCompoundCriteria(CompoundCriteria.AND, crit1, crit2);
    ...
    public void testOrInSelect() {
        QueryImpl query = getFactory().newQuery();
        CompoundCriteriaImpl compoundCriteria = getFactory().newCompoundCriteria(CompoundCriteria.OR,
    ...
    public void testLikeWOConstant() {
        ...
        CriteriaImpl crit = getFactory().newMatchCriteria(getFactory().newObject(a), x);
    ...
    public void testAssignStatement() throws Exception {
        ...
        AssignmentStatementImpl queryStmt = getFactory().newAssignmentStatement(getFactory().newObject(a), query);
        AssignmentStatementImpl exprStmt = getFactory().newAssignmentStatement(getFactory().newObject(a), expr);
    ...
    public void testDynamicCommandStatement() throws Exception {
        ...
        a1.setType(getDataTypeService().getDefaultDataClass(DataTypeName.STRING));
        symbols.add(a1);
    ...
    public void testDynamicCommandStatement1() throws Exception {
        ...
        a2.setType(getDataTypeService().getDefaultDataClass(DataTypeName.INTEGER));
        symbols.add(a2);
    ...
    protected QueryImpl exampleIn(boolean semiJoin) {
        ...
        outer.setSelect(getFactory().newObject(select));
        outer.setFrom(getFactory().newObject(from));
    ...
    public void testSubquerySetCriteriaWithUnion() {
        ...
        SetQueryImpl union = getFactory().newSetQuery(u1, Operation.UNION, u2, true);
    ...
    public void testManyInnerJoins2() {
        ...
        jcrits1.add(getFactory().newCompareCriteria(e1, Operator.EQ, e2));
        List jcrits2 = new ArrayList();
        jcrits2.add(getFactory().newCompareCriteria(getFactory().newObject(e2), Operator.EQ, e3));
        List jcrits3 = new ArrayList();
        jcrits3.add(getFactory().newCompareCriteria(getFactory().newObject(e1), Operator.EQ, e4));
    ...
    public void testLoopStatement() throws Exception {
        ...
        StatementImpl assignmentStmt = getFactory().newAssignmentStatement(getFactory().newObject(x), c1);
    ...
    public void testLoopStatementWithOrderBy() throws Exception {
        ...
        OrderByImpl orderBy = getFactory().newOrderBy();
        orderBy.addVariable(getFactory().newObject(c1));
    ...
    public void testWhileStatement() throws Exception {
        ...
        StatementImpl assignmentStmt = getFactory().newAssignmentStatement(getFactory().newObject(x), f);
        BlockImpl block = getFactory().newBlock();
        block.addStatement(assignmentStmt);
        CriteriaImpl crit = getFactory().newCompareCriteria(getFactory().newObject(x), Operator.LT, getFactory().newConstant(new Integer(100)));
    ...
    public void testAndOrPrecedence_1575() {
        ...
        CompoundCriteriaImpl cc1 = getFactory().newCompoundCriteria(CompoundCriteria.AND, c2, c3);
        CompoundCriteriaImpl cc2 = getFactory().newCompoundCriteria(CompoundCriteria.OR, c1, cc1);
        QueryImpl q = getFactory().newQuery();
        q.setSelect(s);
        q.setFrom(f);
        q.setCriteria(cc2);
    ...
    public void testAndOrPrecedence2_1575() {
        ...
        CompareCriteriaImpl c2 = getFactory().newCompareCriteria(getFactory().newElementSymbol("e2"), Operator.EQ, getFactory().newConstant(new Integer(1)));
        CompareCriteriaImpl c3 = getFactory().newCompareCriteria(getFactory().newElementSymbol("e3"), Operator.EQ, getFactory().newConstant(new Integer(3)));
        CompoundCriteriaImpl cc1 = getFactory().newCompoundCriteria(CompoundCriteria.AND, c1, c2);
        CompoundCriteriaImpl cc2 = getFactory().newCompoundCriteria(CompoundCriteria.OR, cc1, c3);
        QueryImpl q = getFactory().newQuery();
        q.setSelect(s);
        q.setFrom(f);
        q.setCriteria(cc2);
    ...
    protected void helpTestCompoundNonJoinCriteria(String sqlPred, CriteriaImpl predCrit) {
        ...
        CompareCriteriaImpl c1 = getFactory().newCompareCriteria(getFactory().newElementSymbol("e1"), Operator.EQ, getFactory().newConstant(new Integer(0)));
        CompoundCriteriaImpl cc1 = getFactory().newCompoundCriteria(CompoundCriteria.AND, c1, predCrit);
    ...
    public void testElementInDoubleQuotes_Insert() throws Exception {
        ...
        query.setGroup(getFactory().newObject(g));
        query.addVariable(e);
    ...
    public void testElementInDoubleQuotes_Update() throws Exception {
        ...
        SetClauseImpl setClause = getFactory().newSetClause(e, getFactory().newConstant("bar", String.class));        
        SetClauseListImpl setClauseList = getFactory().newSetClauseList();
        setClauseList.addSetClause(setClause);
        query.setChangeList(setClauseList);
    ...
    public void testXmlNamespaces() throws Exception {
        XMLForestImpl f = getFactory().newXMLForest(Arrays.asList(getFactory().newDerivedColumn("table", getFactory().newElementSymbol("a"))));
        NamespaceItem n1 = getFactory().newNode(ASTNodes.NAMESPACE_ITEM);
        NamespaceItem n2 = getFactory().newNode(ASTNodes.NAMESPACE_ITEM);
        n2.setUri("http://foo");
        n2.setPrefix("x");
        f.setNamespaces(getFactory().newXMLNamespaces(Arrays.asList(n1, n2)));
    ...
    public void testXmlAggWithOrderBy() throws Exception {
        ...
        AggregateSymbolImpl as = getFactory().newAggregateSymbol("xmlAgg", false, getFactory().newConstant(1));
    ...
    public void testTextAggWithOrderBy() throws Exception {
        ...
        AggregateSymbolImpl as = getFactory().newAggregateSymbol("TextAgg", false, tf);
        as.setOrderBy(getFactory().newOrderBy(Arrays.asList(getFactory().newElementSymbol("e2"))));
    ...
    public void testArrayAggWithOrderBy() throws Exception {
        ...
        AggregateSymbolImpl as = getFactory().newAggregateSymbol("array_agg", false, getFactory().newConstant(1));
        as.setOrderBy(getFactory().newOrderBy(Arrays.asList(getFactory().newElementSymbol("e2"))));
        QueryImpl query = getFactory().newQuery();
        query.setSelect(getFactory().newSelect(Arrays.asList(as)));
    ...
    public void testXMLTable() throws Exception {
        ...
        xt.setName("x");
        NamespaceItem n1 = getFactory().newNode(ASTNodes.NAMESPACE_ITEM);
        xt.setNamespaces(getFactory().newXMLNamespaces(Arrays.asList(n1)));
        xt.setXquery("/");
    ...
    public void testArrayTable() throws Exception {
        ...
        tt.setArrayValue(getFactory().newConstant(null, getDataTypeService().getDefaultDataClass(DataTypeName.NULL)));
    ...
    public void testAggFilter() throws Exception {
        ...
        QueryImpl query = getFactory().newQuery();
        AggregateSymbolImpl aggregateSymbol = getFactory().newAggregateSymbol(Type.COUNT.name(), false, null);
    ...
    public void testWindowFunction() throws Exception {
        ...
        QueryImpl query = getFactory().newQuery();
        WindowFunctionImpl wf = getFactory().newWindowFunction("win_row_number");
