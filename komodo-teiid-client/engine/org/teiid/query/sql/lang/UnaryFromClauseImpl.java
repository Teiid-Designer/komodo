 ...
 *
 */
public class UnaryFromClauseImpl extends FromClauseImpl implements UnaryFromClause<GroupSymbolImpl, TCLanguageVisitorImpl> {

    private GroupSymbolImpl groupSymbol;
    
    private CommandImpl expandedCommand;

    /**
     * @param p
     * @param id
     */
    public UnaryFromClauseImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
     ...
     */
    public void setExpandedCommand(CommandImpl expandedCommand) {
    ...
    public UnaryFromClauseImpl clone() {
        UnaryFromClauseImpl clone = new UnaryFromClauseImpl(this.parser, this.id);
