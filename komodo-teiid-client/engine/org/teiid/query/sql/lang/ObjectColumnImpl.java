 ...
 *
 */
public class ObjectColumnImpl extends ProjectedColumnImpl implements ObjectColumn<TCLanguageVisitorImpl> {

    private String path;

    private BaseExpression defaultExpression;
     ...
     * @param id
     */
    public ObjectColumnImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
     ...
     */
    public void setDefaultExpression(BaseExpression defaultExpression) {
    ...
    public ObjectColumnImpl clone() {
        ObjectColumnImpl clone = new ObjectColumnImpl(this.parser, this.id);
