 ...
 *
 */
public class NotCriteriaImpl extends CriteriaImpl implements NotCriteria<TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public NotCriteriaImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public NotCriteriaImpl clone() {
        NotCriteriaImpl clone = new NotCriteriaImpl(this.parser, this.id);
