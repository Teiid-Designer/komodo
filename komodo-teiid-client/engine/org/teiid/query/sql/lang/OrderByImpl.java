 ...
 *
 */
public class OrderByImpl extends SimpleNode
    implements OrderBy<BaseExpression, OrderByItemImpl, TCLanguageVisitorImpl> {

    private List<OrderByItemImpl> orderByItems = new ArrayList<OrderByItemImpl>();

    /**
     * @param p
     * @param id
     */
    public OrderByImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
     ...
     */
    @Override
    public void addVariable( BaseExpression element ) {
     ...
     */
    @Override
    public void addVariable( BaseExpression element, boolean type ) {
        if(element == null)
            throw new IllegalArgumentException(Messages.getString(Messages.ERR.ERR_015_010_0021));

        OrderByItemImpl orderByItem = parser.createASTNode(ASTNodes.ORDER_BY_ITEM);
    ...
    public OrderByImpl clone() {
        OrderByImpl clone = new OrderByImpl(this.parser, this.id);
