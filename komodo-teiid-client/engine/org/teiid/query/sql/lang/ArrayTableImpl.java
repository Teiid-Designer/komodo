 ...
 *
 */
public class ArrayTableImpl extends TableFunctionReferenceImpl implements ArrayTable<TCLanguageVisitorImpl> {

    private BaseExpression arrayValue;

    private List<ProjectedColumnImpl> columns = new ArrayList<ProjectedColumnImpl>();

    /**
     * @param p
     * @param id
     */
    public ArrayTableImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public ArrayTableImpl clone() {
        ArrayTableImpl clone = new ArrayTableImpl(this.parser, this.id);
