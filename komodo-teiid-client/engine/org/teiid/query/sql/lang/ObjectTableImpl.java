...
public class ObjectTableImpl extends TableFunctionReferenceImpl implements ObjectTable<TCLanguageVisitorImpl> {
    ...
    private List<ObjectColumnImpl> columns = new ArrayList<ObjectColumnImpl>();
     ...
     * @param id
     */
    public ObjectTableImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public ObjectTableImpl clone() {
        ObjectTableImpl clone = new ObjectTableImpl(this.parser, this.id);
