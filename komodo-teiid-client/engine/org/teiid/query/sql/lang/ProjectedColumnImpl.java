 ...
 *
 */
public class ProjectedColumnImpl extends SimpleNode implements ProjectedColumn<TCLanguageVisitorImpl> {
    
    private String name;

    private String type;

    private ElementSymbolImpl symbol;

    /**
     * @param p
     * @param id
     */
    public ProjectedColumnImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public ProjectedColumnImpl clone() {
        ProjectedColumnImpl clone = new ProjectedColumnImpl(this.parser, this.id);
