 ...
 *
 */
public class OptionImpl extends SimpleNode implements Option<TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public OptionImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public OptionImpl clone() {
        OptionImpl clone = new OptionImpl(this.parser, this.id);
