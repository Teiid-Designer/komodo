...
public class UpdateImpl extends ProcedureContainer
    implements BaseTargetedCommand, Update<BaseExpression, TCLanguageVisitorImpl> {

    private SetClauseListImpl changeList;
     ...
     * @param id
     */
    public UpdateImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
     ...
     */
    public void addChange(ElementSymbolImpl id, BaseExpression value) {
        if (changeList == null)
            changeList = parser.createASTNode(ASTNodes.SET_CLAUSE_LIST);

        SetClauseImpl setClause = parser.createASTNode(ASTNodes.SET_CLAUSE);
     ...
     */
    public void setChangeList(SetClauseListImpl changeList) {
    ...
    public UpdateImpl clone() {
        UpdateImpl clone = new UpdateImpl(this.parser, this.id);
