 ...
 *
 */
public class TextLineImpl extends SimpleNode implements BaseExpression, TextLine<TCLanguageVisitorImpl> {
    ...
    private List<DerivedColumnImpl> expressions;
     ...
     * @param id
     */
    public TextLineImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public TextLineImpl clone() {
        TextLineImpl clone = new TextLineImpl(this.parser, this.id);
