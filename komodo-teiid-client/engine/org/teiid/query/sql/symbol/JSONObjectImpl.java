 ...
 *
 */
public class JSONObjectImpl extends SimpleNode implements BaseExpression, JSONObject<TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public JSONObjectImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public JSONObjectImpl clone() {
        JSONObjectImpl clone = new JSONObjectImpl(this.parser, this.id);
