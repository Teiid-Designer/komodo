 ...
 *
 */
public class GroupSymbolImpl extends SymbolImpl implements GroupSymbol<TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public GroupSymbolImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public String getCanonicalName() {
        if (this.schema != null) {
            return this.schema + Symbol.SEPARATOR + this.getShortCanonicalName();
        }
