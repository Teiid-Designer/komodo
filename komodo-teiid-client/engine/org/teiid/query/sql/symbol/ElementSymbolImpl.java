...
public class ElementSymbolImpl extends SymbolImpl implements SingleElementSymbol, BaseExpression, ElementSymbol<GroupSymbolImpl, TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public ElementSymbolImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
     ...
     */
    @Override
    public void setGroupSymbol(GroupSymbolImpl symbol) {
    ...
    public String getName() {
        if (this.groupSymbol != null) {
            return this.groupSymbol.getName() + SymbolImpl.SEPARATOR + this.getShortName();
        }
    ...
    public void setName(String name) {
        ...
        if (index > 0) {
            ...
            GroupSymbolImpl gs = parser.createASTNode(ASTNodes.GROUP_SYMBOL);
    ...
    public ElementSymbolImpl clone() {
        ElementSymbolImpl clone = new ElementSymbolImpl(this.parser, this.id);
