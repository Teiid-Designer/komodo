 ...
 *
 */
public class XMLParseImpl extends SimpleNode implements BaseExpression, XMLParse<TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public XMLParseImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public XMLParseImpl clone() {
        XMLParseImpl clone = new XMLParseImpl(this.parser, this.id);
