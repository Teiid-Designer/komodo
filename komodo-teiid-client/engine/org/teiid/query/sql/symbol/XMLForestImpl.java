 ...
 *
 */
public class XMLForestImpl extends SimpleNode implements BaseExpression, XMLForest<TCLanguageVisitorImpl> {
     ...
     * @param id
     */
    public XMLForestImpl(TeiidClientParser p, int id) {
        super(p, id);
    }
    ...
    public XMLForestImpl clone() {
        XMLForestImpl clone = new XMLForestImpl(this.parser, this.id);
