...
public class MappingOutputter {
    ...
    public MappingOutputter() {
        ...
        if (xof.isPropertySupported(P_OUTPUT_VALIDATE_STRUCTURE)) {
            xof.setProperty(P_OUTPUT_VALIDATE_STRUCTURE, false);
        }
    }
    ...
    void addElementProperty(String name, Object value ) throws XMLStreamException {
        if ( value == null ) {
            throw new IllegalArgumentException( Messages.getString(Messages.ERR.ERR_015_002_0010, name) ); //$NON-NLS-1$
        }
    ...
    private String getXMLText( Object obj ) {
        if ( obj instanceof String ) {
            ...
            throw new IllegalArgumentException( Messages.getString(Messages.ERR.ERR_015_002_0011, obj.getClass().getName() )); //$NON-NLS-1$
        }
    }
