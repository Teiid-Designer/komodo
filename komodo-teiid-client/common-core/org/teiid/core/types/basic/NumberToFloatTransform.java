...
public class NumberToFloatTransform extends Transform {
	...
	public NumberToFloatTransform(DefaultDataTypeManager dataTypeManager, Class<?> sourceType, boolean isNarrowing, boolean isLossy) {
	...
	public Class<?> getTargetType() {
		return DefaultDataTypeManager.DefaultDataTypes.FLOAT.getTypeClass();
	}
